...
class Search {
	...
	protected function setup_hooks() {
		...
		// Lock search algorithm to 3.4 for backwards compat purposes
		dd_filter( 'ep_search_algorithm_version', [ $this, 'filter__ep_search_algorithm_version' ], 9999 );
	}
	...
	/**
	 * Filter out the default algorithm version to be used.
	 * 
