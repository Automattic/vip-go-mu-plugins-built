<?php
/**
 * Page: jetpack-forms-responses (wp-admin integrated)
...
function jetpack_forms_jetpack_forms_responses_wp_admin_enqueue_scripts( $hook_suffix ) {
	...
	$is_our_page = (
		( isset( $_GET['page'] ) && 'jetpack-forms-responses-wp-admin' === $_GET['page'] ) || // phpcs:ignore WordPress.Security.NonceVerification.Recommended
	...
	if ( file_exists( $asset_file ) ) {
		...
		wp_register_style( 'jetpack-forms-responses-wp-admin-prerequisites', false, $style_dependencies, $asset['version'] );

		// Build dependencies for jetpack-forms-responses-wp-admin module
		 ...
		 * jetpack-forms-responses-wp-admin page.
		 *
		...
		$boot_dependencies = apply_filters(
			'jetpack-forms-responses-wp-admin_boot_dependencies',
			$boot_dependencies
		);
		...
		wp_enqueue_script( 'jetpack-forms-responses-wp-admin-prerequisites' );
		wp_enqueue_script_module( 'jetpack-forms-responses-wp-admin' );
		wp_enqueue_style( 'jetpack-forms-responses-wp-admin-prerequisites' );
	}
}
...
function jetpack_forms_jetpack_forms_responses_wp_admin_render_page() {
	...
	<div id="jetpack-forms-responses-wp-admin-app" class="boot-layout-container"></div>
	<?php
}
