 ...
 *
 * Note: These styles can be overridden by calling jetpack_social_override_style()
 ...
 */
function jetpack_social_override_style( $styles, $handle, $src, $deps = array(), $ver = false, $media = 'all' ) {
 ...
 * @param WP_Styles $styles WP_Styles instance.
 */
function jetpack_social_register_package_styles( $styles ) {
...
add_action( 'wp_default_styles', 'jetpack_social_register_package_styles' );
