...
global $gutenberg_experiments_routes, $gutenberg_experiments_menu_items;
$gutenberg_experiments_routes     = array();
$gutenberg_experiments_menu_items = array();
 ...
 */
function gutenberg_register_experiments_route( $path, $content_module = null, $route_module = null ) {
	global $gutenberg_experiments_routes;
	...
	$gutenberg_experiments_routes[] = $route;
}
 ...
 */
function gutenberg_register_experiments_menu_item( $id, $label, $to, $parent_id = '', $parent_type = '' ) {
	global $gutenberg_experiments_menu_items;
	...
	$gutenberg_experiments_menu_items[] = $menu_item;
}
 ...
 */
function gutenberg_get_experiments_routes() {
	global $gutenberg_experiments_routes;
	return $gutenberg_experiments_routes ?? array();
}
 ...
 */
function gutenberg_get_experiments_menu_items() {
	global $gutenberg_experiments_menu_items;
	return $gutenberg_experiments_menu_items ?? array();
}
 ...
 */
function gutenberg_experiments_preload_data() {
 ...
 */
function gutenberg_experiments_render_page() {
	...
	/**
	 * Fires when the experiments page is initialized so extensions can register routes and menu items.
	 */
	...
	gutenberg_experiments_preload_data();

	// Get all registered routes and menu items
	$menu_items = gutenberg_get_experiments_menu_items();
	$routes = gutenberg_get_experiments_routes();
 ...
 */
function gutenberg_experiments_intercept_render() {
	// phpcs:ignore WordPress.Security.NonceVerification.Recommended
	if ( isset( $_GET['page'] ) && 'experiments' === $_GET['page'] ) {
		gutenberg_experiments_render_page();
		exit;
	}
}

// Hook the interceptor to admin_init
add_action( 'admin_init', 'gutenberg_experiments_intercept_render' );
