...
global $gutenberg_guidelines_routes, $gutenberg_guidelines_menu_items;
$gutenberg_guidelines_routes     = array();
$gutenberg_guidelines_menu_items = array();
 ...
 */
function gutenberg_register_guidelines_route( $path, $content_module = null, $route_module = null ) {
	global $gutenberg_guidelines_routes;
	...
	$gutenberg_guidelines_routes[] = $route;
}
 ...
 */
function gutenberg_register_guidelines_menu_item( $id, $label, $to, $parent_id = '', $parent_type = '' ) {
	global $gutenberg_guidelines_menu_items;
	...
	$gutenberg_guidelines_menu_items[] = $menu_item;
}
 ...
 */
function gutenberg_get_guidelines_routes() {
	global $gutenberg_guidelines_routes;
	return $gutenberg_guidelines_routes ?? array();
}
 ...
 */
function gutenberg_get_guidelines_menu_items() {
	global $gutenberg_guidelines_menu_items;
	return $gutenberg_guidelines_menu_items ?? array();
}
 ...
 */
function gutenberg_guidelines_preload_data() {
 ...
 */
function gutenberg_guidelines_render_page() {
	...
	gutenberg_guidelines_preload_data();

	// Get all registered routes and menu items
	$menu_items = gutenberg_get_guidelines_menu_items();
	$routes = gutenberg_get_guidelines_routes();
 ...
 */
function gutenberg_guidelines_intercept_render() {
	// phpcs:ignore WordPress.Security.NonceVerification.Recommended
	if ( isset( $_GET['page'] ) && 'guidelines' === $_GET['page'] ) {
		gutenberg_guidelines_render_page();
		exit;
	}
}

// Hook the interceptor to admin_init
add_action( 'admin_init', 'gutenberg_guidelines_intercept_render' );
