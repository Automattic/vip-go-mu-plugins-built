...
// widgets/hello-dolly/style.module.css
if (typeof process === "undefined" || true) {
  registerStyle4("3bce80a8be", "._0a72644d00175b3d__root{background-color:var(--wpds-color-background-surface-brand,color-mix(in oklch,var(--wp-admin-theme-color,#3858e9) 9%,#fff));color:var(--wpds-color-foreground-interactive-brand,var(--wp-admin-theme-color,#3858e9));height:100%;padding:var(--wpds-dimension-padding-2xl,24px)}._27db09cc57742421__quote{font-family:Georgia,Times New Roman,Times,serif;font-style:italic;text-align:center}");
}
var style_default4 = { "root": "_0a72644d00175b3d__root", "quote": "_27db09cc57742421__quote" };
...
function HelloDolly() {
  const quote = (0, import_element4.useMemo)(() => {
    return DOLLY_LYRICS[Math.floor(Math.random() * DOLLY_LYRICS.length)];
  }, []);
