...
function gutenberg_render_block_core_image( $attributes, $content, $block ) {
	...
	if (
		 ...
		 * introduced.
		 */
		add_filter( 'render_block_core/image', 'gutenberg_block_core_image_render_lightbox', 15, 3 );
	} else {
		/*
 ...
 */
function gutenberg_block_core_image_render_lightbox( $block_content, array $block, WP_Block $block_instance ) {
	/*
