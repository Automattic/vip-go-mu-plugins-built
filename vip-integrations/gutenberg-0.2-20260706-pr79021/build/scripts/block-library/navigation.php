 ...
 */
function gutenberg_block_core_navigation_add_state_class_to_container( $block_content, $block ) {
...
add_filter( 'render_block', 'gutenberg_block_core_navigation_add_state_class_to_container', 11, 2 );
