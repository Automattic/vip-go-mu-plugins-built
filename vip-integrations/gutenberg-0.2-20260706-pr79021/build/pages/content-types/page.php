...
global $gutenberg_content_types_routes, $gutenberg_content_types_menu_items;
$gutenberg_content_types_routes     = array();
$gutenberg_content_types_menu_items = array();
 ...
 */
function gutenberg_register_content_types_route( $path, $content_module = null, $route_module = null ) {
	global $gutenberg_content_types_routes;
	...
	$gutenberg_content_types_routes[] = $route;
}
 ...
 */
function gutenberg_register_content_types_menu_item( $id, $label, $to, $parent_id = '', $parent_type = '' ) {
	global $gutenberg_content_types_menu_items;
	...
	$gutenberg_content_types_menu_items[] = $menu_item;
}
 ...
 */
function gutenberg_get_content_types_routes() {
	global $gutenberg_content_types_routes;
	return $gutenberg_content_types_routes ?? array();
}
 ...
 */
function gutenberg_get_content_types_menu_items() {
	global $gutenberg_content_types_menu_items;
	return $gutenberg_content_types_menu_items ?? array();
}
 ...
 */
function gutenberg_content_types_preload_data() {
 ...
 */
function gutenberg_content_types_render_page() {
	...
	gutenberg_content_types_preload_data();

	// Get all registered routes and menu items
	$menu_items = gutenberg_get_content_types_menu_items();
	$routes = gutenberg_get_content_types_routes();
 ...
 */
function gutenberg_content_types_intercept_render() {
	// phpcs:ignore WordPress.Security.NonceVerification.Recommended
	if ( isset( $_GET['page'] ) && 'content-types' === $_GET['page'] ) {
		gutenberg_content_types_render_page();
		exit;
	}
}

// Hook the interceptor to admin_init
add_action( 'admin_init', 'gutenberg_content_types_intercept_render' );
