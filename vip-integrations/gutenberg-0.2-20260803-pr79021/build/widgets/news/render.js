...
if (typeof process === "undefined" || true) {
  registerStyle13("708b8eb3a7", "@layer wp-ui{@layer utilities, components, compositions, overrides;@layer utilities{._3c9f5ee9fc9c136d__outset-ring--focus-within-except-active:focus-within:not(:has(:active)),._64de9947bf305b7a__outset-ring--focus-within-visible:focus-within:has(:focus-visible),.abc777e9713fa711__outset-ring--focus-except-active:focus:not(:active),.af79fb116edb0dd7__outset-ring--focus:focus,.dfcfdc28396e5d98__outset-ring--focus-visible:focus-visible,.e5cd9ee879f6403a__outset-ring--focus-within:focus-within,:focus-visible ._81935a08e952f267__outset-ring--focus-parent-visible{--focus-color:var(--wpds-color-stroke-focus,var(--wp-admin-theme-color,#3858e9));--_gcd-a-outline:var(--wpds-border-width-focus,var(--wp-admin-border-width-focus,2px)) solid var(--wpds-color-stroke-focus,var(--wp-admin-theme-color,#3858e9));--_gcd-div-outline:var(--wpds-border-width-focus,var(--wp-admin-border-width-focus,2px)) solid var(--wpds-color-stroke-focus,var(--wp-admin-theme-color,#3858e9));outline:var(--wpds-border-width-focus,var(--wp-admin-border-width-focus,2px)) solid var(--focus-color);outline-offset:var(--wpds-border-width-focus,var(--wp-admin-border-width-focus,2px))}}}");
}
var focus_module_default = { "outset-ring--focus": "af79fb116edb0dd7__outset-ring--focus", "outset-ring--focus-except-active": "abc777e9713fa711__outset-ring--focus-except-active", "outset-ring--focus-visible": "dfcfdc28396e5d98__outset-ring--focus-visible", "outset-ring--focus-within": "e5cd9ee879f6403a__outset-ring--focus-within", "outset-ring--focus-within-except-active": "_3c9f5ee9fc9c136d__outset-ring--focus-within-except-active", "outset-ring--focus-within-visible": "_64de9947bf305b7a__outset-ring--focus-within-visible", "outset-ring--focus-parent-visible": "_81935a08e952f267__outset-ring--focus-parent-visible" };
if (typeof process === "undefined" || true) {
...
var useFocusable = createHook(function useFocusable2({ focusable: focusable2 = true, accessibleWhenDisabled, autoFocus, onFocusVisible, ...props }) {
  ...
  const [elementCapabilities, setElementCapabilities] = (0, import_react13.useState)(defaultElementCapabilities);
  useSafeLayoutEffect(() => {
    const element = ref.current;
    if (!element) return;
...
function useStableStoreKeys(keys) {
  const keysRef = React48.useRef(null);
...
var useCombobox = createHook(function useCombobox2({ store, focusable: focusable2 = true, autoSelect: autoSelectProp = false, getAutoSelectId, setValueOnChange, showMinLength = 0, showOnChange, showOnMouseDown, showOnClick = showOnMouseDown, showOnKeyDown, showOnKeyPress = showOnKeyDown, blurActiveItemOnClick, setValueOnClick = true, moveOnKeyPress = true, autoComplete = "list", name, form, disabled: disabled2, ...props }) {
  ...
  const compositionEndFrameRef = (0, import_react23.useRef)(null);
  ...
  (0, import_react23.useEffect)(() => cancelCompositionEndFrame, []);
  ...
  props = useWrapElement(props, (element) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime76.jsxs)(import_jsx_runtime76.Fragment, { children: [element, selectedValue.map((value2, index2) => /* @__PURE__ */ (0, import_jsx_runtime76.jsx)("input", {
      type: "hidden",
      name,
      form,
...
function FeedIcon({ item }) {
  return /* @__PURE__ */ (0, import_jsx_runtime123.jsx)("div", { className: news_list_default.feedIcon, "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime123.jsx)(Icon, { icon: item.feedKey === "news" ? wordpress_default : globe_default }) });
}
function NewsTitle({ item }) {
  return /* @__PURE__ */ (0, import_jsx_runtime123.jsx)(Link, { href: item.url, openInNewTab: true, className: news_list_default.titleLink, children: item.title });
}
function NewsMeta({ item }) {
  return /* @__PURE__ */ (0, import_jsx_runtime123.jsxs)(Text, { variant: "body-sm", className: news_list_default.meta, children: [
    item.feedLabel,
    " \xB7 ",
    (0, import_date10.dateI18n)((0, import_i18n45.__)("M j, Y g:i a"), item.date)
  ] });
}
var emptyState = /* @__PURE__ */ (0, import_jsx_runtime123.jsx)(Stack, { align: "center", justify: "center", style: { margin: "24px 0" }, children: /* @__PURE__ */ (0, import_jsx_runtime123.jsxs)(empty_state_exports.Root, { children: [
  /* @__PURE__ */ (0, import_jsx_runtime123.jsx)(empty_state_exports.Icon, { icon: post_list_default }),
  /* @__PURE__ */ (0, import_jsx_runtime123.jsx)(empty_state_exports.Title, { children: (0, import_i18n45.__)("Quiet for now \u2014 the next headline is on its way.") })
] }) });
    ...
    () => [
      {
        ...
        enableSorting: false,
        enableHiding: false,
        render: ({ item }) => /* @__PURE__ */ (0, import_jsx_runtime123.jsx)(NewsTitle, { item })
      },
      {
        id: "meta",
        ...
        enableSorting: false,
        enableHiding: false,
        render: ({ item }) => /* @__PURE__ */ (0, import_jsx_runtime123.jsx)(NewsMeta, { item })
      },
      {
        id: "feedIcon",
        label: (0, import_i18n45.__)("Source"),
        enableSorting: false,
        enableHiding: false,
        render: ({ item }) => /* @__PURE__ */ (0, import_jsx_runtime123.jsx)(FeedIcon, { item })
      }
    ],
    []
  );
  return /* @__PURE__ */ (0, import_jsx_runtime123.jsx)("div", { className: news_list_default.root, children: /* @__PURE__ */ (0, import_jsx_runtime123.jsx)(
    dataviews_default,
    {
      data: items,
      fields,
...
function WordPressNews() {
  return /* @__PURE__ */ (0, import_jsx_runtime124.jsxs)(import_jsx_runtime124.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime124.jsx)(NewsList, {}),
    /* @__PURE__ */ (0, import_jsx_runtime124.jsx)("div", { className: render_default.footer, children: /* @__PURE__ */ (0, import_jsx_runtime124.jsx)(
      Link,
      {
