 ...
 */
function gutenberg_block_core_list_render( $attributes, $content ) {
	if ( ! $content ) {
		return $content;
	}
 ...
 * @since 6.6.0
 */
function gutenberg_register_block_core_list() {
	register_block_type_from_metadata(
		__DIR__ . '/list',
		array(
			'render_callback' => 'gutenberg_block_core_list_render',
		)
	);
}

add_action( 'init', 'gutenberg_register_block_core_list', 20 );
