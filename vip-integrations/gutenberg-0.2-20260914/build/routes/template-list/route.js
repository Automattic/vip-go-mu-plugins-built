...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React96 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState25 = React96.useState, useEffect23 = React96.useEffect, useLayoutEffect4 = React96.useLayoutEffect, useDebugValue2 = React96.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React96 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore3 = shim.useSyncExternalStore, useRef43 = React96.useRef, useEffect23 = React96.useEffect, useMemo31 = React96.useMemo, useDebugValue2 = React96.useDebugValue;
...
var FieldRootContext = /* @__PURE__ */ React32.createContext(DEFAULT_FIELD_ROOT_CONTEXT);
if (true) FieldRootContext.displayName = "FieldRootContext";
function useFieldRootContext(optional = true) {
  const context = React32.useContext(FieldRootContext);
...
function useFormContext() {
  return React33.useContext(FormContext);
}
...
var LabelableContext = /* @__PURE__ */ React34.createContext({
  controlId: void 0,
...
function useLabelableContext() {
  return React34.useContext(LabelableContext);
}
...
function useLabelableId(params = {}) {
  ...
  const hasRegisteredRef = React35.useRef(false);
  const hadExplicitIdRef = React35.useRef(id != null);
...
var FieldItemContext = /* @__PURE__ */ React39.createContext({
  disabled: false
});
if (true) FieldItemContext.displayName = "FieldItemContext";
function useFieldItemContext() {
  const context = React39.useContext(FieldItemContext);
  return context;
}
...
function useFieldValidation(params) {
  ...
  const validationCommitIdRef = React40.useRef(0);
  const registerInput = React40.useCallback((element, registration) => {
  ...
  const getValidationProps = React40.useCallback((disabled2, externalProps = {}) => mergeProps(getDescriptionProps(externalProps), state.valid === false && !state.disabled && !disabled2 ? {
    "aria-invalid": true
...
var FieldsetRootContext = /* @__PURE__ */ React45.createContext(void 0);
...
var LabelableProvider = function LabelableProvider2(props) {
  ...
  const [controlId, setControlIdState] = React46.useState(initialControlId);
  const [labelId, setLabelId] = React46.useState(props.labelId);
  const [messageIds, setMessageIds] = React46.useState([]);
  ...
  const getDescriptionProps = React46.useCallback((externalProps) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(LabelableContext.Provider, {
    value: contextValue,
    children: props.children
  });
};
...
function useFieldControlRegistration(params) {
  ...
  const activeFieldControlSourceRef = React47.useRef(null);
  const registrationRef = React47.useRef(null);
  const initialValueCapturedRef = React47.useRef(false);
...
var FieldRootInner = /* @__PURE__ */ React48.forwardRef(function FieldRootInner2(componentProps, forwardedRef) {
  const {
    errors,
  ...
  const [touchedState, setTouchedUnwrapped] = React48.useState(false);
  const [dirtyState, setDirtyUnwrapped] = React48.useState(false);
  const [filled, setFilled] = React48.useState(false);
  const [focused, setFocused] = React48.useState(false);
  const dirty = dirtyProp ?? dirtyState;
  const touched = touchedProp ?? touchedState;
  const markedDirtyRef = React48.useRef(dirty);
  const registeredFieldIdRef = React48.useRef(void 0);
  const [registeredFieldName, setRegisteredFieldName] = React48.useState();
  ...
  const [validityData, setValidityData] = React48.useState({
    state: DEFAULT_VALIDITY_STATE,
    error: "",
    errors: [],
    value: null,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(FieldRootContext.Provider, {
    value: contextValue,
    children: element
  });
});
if (true) FieldRootInner.displayName = "FieldRootInner";
var FieldRoot = /* @__PURE__ */ React48.forwardRef(function FieldRoot2(componentProps, forwardedRef) {
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(LabelableProvider, {
    children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(FieldRootInner, {
      ...componentProps,
      ref: forwardedRef
    })
  });
...
var FieldLabel = /* @__PURE__ */ React49.forwardRef(function FieldLabel2(componentProps, forwardedRef) {
  const {
    render: render4,
    className,
    style,
  ...
  const labelRef = React49.useRef(null);
...
var FieldError = /* @__PURE__ */ React50.forwardRef(function FieldError2(componentProps, forwardedRef) {
  const {
    render: render4,
    id: idProp,
    className,
  ...
  const errorRef = React50.useRef(null);
  const [lastRenderedMessage, setLastRenderedMessage] = React50.useState(null);
  const [lastRenderedMessageKey, setLastRenderedMessageKey] = React50.useState(null);
  ...
  if (Array.isArray(error2)) {
    errorMessage = error2.length > 1 ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("ul", {
      children: error2.map((message2) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("li", {
        children: message2
      }, message2))
    }) : error2[0];
  }
...
var FieldDescription = /* @__PURE__ */ React51.forwardRef(function FieldDescription2(componentProps, forwardedRef) {
  const {
    render: render4,
    id: idProp,
    className,
...
var FieldControl = /* @__PURE__ */ React52.forwardRef(function FieldControl2(componentProps, forwardedRef) {
  const {
    render: render4,
    className,
    id: idProp,
...
var FieldValidity = function FieldValidity2(props) {
  ...
  const combinedFieldValidityData = React53.useMemo(() => getCombinedFieldValidityData(validityData, invalid), [validityData, invalid]);
  const isInvalid = combinedFieldValidityData.state.valid === false;
  const {
    transitionStatus
  } = useTransitionStatus(isInvalid);
  const fieldValidityState = React53.useMemo(() => {
    return {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(React53.Fragment, {
...
var FieldItem = /* @__PURE__ */ React54.forwardRef(function FieldItem2(componentProps, forwardedRef) {
  const {
    render: render4,
    className,
    style,
  ...
  const fieldItemContext = React54.useMemo(() => ({
    disabled: disabled2
  }), [disabled2]);
  const element = useRenderElement("div", componentProps, {
    ref: forwardedRef,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(LabelableProvider, {
    children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(FieldItemContext.Provider, {
...
var Input = /* @__PURE__ */ React55.forwardRef(function Input2(props, forwardedRef) {
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(index_parts_exports.Control, {
    ref: forwardedRef,
    ...props
  });
});
...
var FloatingPortalLite = /* @__PURE__ */ React56.forwardRef(function FloatingPortalLite2(componentProps, forwardedRef) {
  const {
    children,
    container,
    className,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(React56.Fragment, {
...
var TooltipRootContext = /* @__PURE__ */ React57.createContext(void 0);
if (true) TooltipRootContext.displayName = "TooltipRootContext";
function useTooltipRootContext(optional) {
  const context = React57.useContext(TooltipRootContext);
  if (context === void 0 && !optional) {
...
function createInitialContext(triggerElements) {
  return {
    popupRef: /* @__PURE__ */ React58.createRef(),
    onOpenChange: void 0,
...
var TooltipRoot = fastComponent(function TooltipRoot2(props) {
  ...
  const previousInstantTypeRef = React59.useRef(null);
  useIsoLayoutEffect(() => {
  ...
  React59.useImperativeHandle(actionsRef, () => ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(TooltipRootContext.Provider, {
    value: store,
    children: [handle && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(PopupHandleAttachment, {
      handle,
      store
    }), shouldRenderInteractions && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(TooltipInteractions, {
      store,
      disabled: disabled2,
      trackCursorAxis
...
function TooltipInteractions({
  ...
  const triggerProps = React59.useMemo(() => mergeProps(clientPoint.reference, dismiss.reference), [clientPoint.reference, dismiss.reference]);
...
var TooltipProviderContext = /* @__PURE__ */ React60.createContext(void 0);
if (true) TooltipProviderContext.displayName = "TooltipProviderContext";
function useTooltipProviderContext() {
  return React60.useContext(TooltipProviderContext);
}
...
var TooltipTrigger = fastComponentRef(function TooltipTrigger2(componentProps, forwardedRef) {
  ...
  const floatingRootContext = store.useState("floatingRootContext");
  const triggerElementRef = React61.useRef(null);
  ...
  const isNestedTriggerHoveredRef = React61.useRef(false);
  const nestedTriggerOpenTimeout = useTimeout();
  const pointerTypeRef = React61.useRef(void 0);
...
var TooltipPortalContext = /* @__PURE__ */ React62.createContext(void 0);
if (true) TooltipPortalContext.displayName = "TooltipPortalContext";
function useTooltipPortalContext() {
  const value = React62.useContext(TooltipPortalContext);
  if (value === void 0) {
...
var TooltipPortal = /* @__PURE__ */ React63.forwardRef(function TooltipPortal2(props, forwardedRef) {
  const {
    keepMounted = false,
    ...portalProps
  } = props;
...
var TooltipPositionerContext = /* @__PURE__ */ React64.createContext(void 0);
if (true) TooltipPositionerContext.displayName = "TooltipPositionerContext";
function useTooltipPositionerContext() {
  const context = React64.useContext(TooltipPositionerContext);
  if (context === void 0) {
...
var TooltipPositioner = /* @__PURE__ */ React65.forwardRef(function TooltipPositioner2(componentProps, forwardedRef) {
  const {
    render: render4,
    className,
    anchor,
...
var TooltipPopup = /* @__PURE__ */ React66.forwardRef(function TooltipPopup2(componentProps, forwardedRef) {
  const {
    render: render4,
    className,
    style,
...
var TooltipArrow = /* @__PURE__ */ React67.forwardRef(function TooltipArrow2(componentProps, forwardedRef) {
  const {
    render: render4,
    className,
    style,
...
var TooltipProvider = function TooltipProvider2(props) {
  ...
  const delayValue = React68.useMemo(() => ({
    open: delay,
    close: closeDelay
  }), [delay, closeDelay]);
...
var TooltipViewport = /* @__PURE__ */ React69.forwardRef(function TooltipViewport2(componentProps, forwardedRef) {
  const {
    render: render4,
    className,
    style,
...
var Trigger = (0, import_element14.forwardRef)(
  function TooltipTrigger3(props, ref) {
    return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(index_parts_exports2.Trigger, { ref, ...props });
  }
);
...
function DirectionProvider3({ children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(DirectionProvider, { direction: (0, import_i18n.isRTL)() ? "rtl" : "ltr", children });
}

// packages/ui/build-module/tooltip/root.mjs
var import_jsx_runtime23 = __toESM(require_jsx_runtime(), 1);
function Root(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(DirectionProvider3, { children: /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(index_parts_exports2.Root, { ...props }) });
}

// packages/icons/build-module/library/chevron-left.mjs
var import_primitives = __toESM(require_primitives(), 1);
var import_jsx_runtime24 = __toESM(require_jsx_runtime(), 1);
var chevron_left_default = /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(import_primitives.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", style: { fill: "none" }, stroke: "currentColor", strokeWidth: "1.5", children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(import_primitives.Path, { d: "M14 6.5L9 12L14 17.5", vectorEffect: "non-scaling-stroke" }) });

// packages/icons/build-module/library/chevron-right.mjs
var import_primitives2 = __toESM(require_primitives(), 1);
var import_jsx_runtime25 = __toESM(require_jsx_runtime(), 1);
var chevron_right_default = /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(import_primitives2.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", style: { fill: "none" }, stroke: "currentColor", strokeWidth: "1.5", children: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(import_primitives2.Path, { d: "M10 6.5L15 12L10 17.5", vectorEffect: "non-scaling-stroke" }) });

// packages/icons/build-module/library/envelope.mjs
var import_primitives3 = __toESM(require_primitives(), 1);
var import_jsx_runtime26 = __toESM(require_jsx_runtime(), 1);
var envelope_default = /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(import_primitives3.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", style: { fill: "none" }, stroke: "currentColor", strokeWidth: "1.5", children: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(import_primitives3.Path, { d: "M20.25 8.5V7C20.25 6.30964 19.6904 5.75 19 5.75H5C4.30964 5.75 3.75 6.30964 3.75 7V8.5M20.25 8.5V17C20.25 17.6904 19.6904 18.25 19 18.25H5C4.30964 18.25 3.75 17.6904 3.75 17V8.5M20.25 8.5L12 14.5L3.75 8.5", vectorEffect: "non-scaling-stroke" }) });

// packages/icons/build-module/library/error.mjs
var import_primitives4 = __toESM(require_primitives(), 1);
var import_jsx_runtime27 = __toESM(require_jsx_runtime(), 1);
var error_default = /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(import_primitives4.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", style: { fill: "none" }, stroke: "currentColor", strokeWidth: "1.5", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(import_primitives4.Path, { d: "M12 9L12 14M12 15.5V17M11.1284 5.04947L3.83827 18.0097C3.46331 18.6763 3.94502 19.5 4.70985 19.5H19.2902C20.055 19.5 20.5367 18.6763 20.1617 18.0097L12.8716 5.04947C12.4893 4.36982 11.5107 4.36982 11.1284 5.04947Z", vectorEffect: "non-scaling-stroke" }) });

// packages/icons/build-module/library/link.mjs
var import_primitives5 = __toESM(require_primitives(), 1);
var import_jsx_runtime28 = __toESM(require_jsx_runtime(), 1);
var link_default = /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_primitives5.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", style: { fill: "none" }, stroke: "currentColor", strokeWidth: "1.5", children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(import_primitives5.Path, { d: "M9.5 12L14.5 12M10 7.75H8.25C5.90279 7.75 4 9.65279 4 12C4 14.3472 5.90279 16.25 8.25 16.25H10M14 16.25H15.75C18.0972 16.25 20 14.3472 20 12C20 9.65279 18.0972 7.75 15.75 7.75L14 7.75", vectorEffect: "non-scaling-stroke" }) });

// packages/icons/build-module/library/mobile.mjs
var import_primitives6 = __toESM(require_primitives(), 1);
var import_jsx_runtime29 = __toESM(require_jsx_runtime(), 1);
var mobile_default = /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_primitives6.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", style: { fill: "none" }, stroke: "currentColor", strokeWidth: "1.5", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_primitives6.Path, { d: "M11 16.5H13M16.25 18V6C16.25 5.30964 15.6904 4.75 15 4.75H9C8.30964 4.75 7.75 5.30964 7.75 6L7.75 18C7.75 18.6904 8.30964 19.25 9 19.25H15C15.6904 19.25 16.25 18.6904 16.25 18Z", vectorEffect: "non-scaling-stroke" }) });

// packages/icons/build-module/library/published.mjs
var import_primitives7 = __toESM(require_primitives(), 1);
var import_jsx_runtime30 = __toESM(require_jsx_runtime(), 1);
var published_default = /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)(import_primitives7.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", style: { fill: "none" }, stroke: "currentColor", strokeWidth: "1.5", children: [
  /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(import_primitives7.Path, { d: "M12 19.25C16.0041 19.25 19.25 16.0041 19.25 12C19.25 7.99594 16.0041 4.75 12 4.75C7.99594 4.75 4.75 7.99594 4.75 12C4.75 16.0041 7.99594 19.25 12 19.25Z", strokeLinejoin: "round", vectorEffect: "non-scaling-stroke" }),
  /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(import_primitives7.Path, { d: "M9 12L11 14L15 10", vectorEffect: "non-scaling-stroke" })
] });

// packages/icons/build-module/library/seen.mjs
var import_primitives8 = __toESM(require_primitives(), 1);
var import_jsx_runtime31 = __toESM(require_jsx_runtime(), 1);
var seen_default = /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)(import_primitives8.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", style: { fill: "none" }, stroke: "currentColor", strokeWidth: "1.5", children: [
  /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(import_primitives8.Path, { d: "M20.0645 13C18.5918 10.0366 15.5337 8 12 8C8.46631 8 5.40825 10.0366 3.93555 13", vectorEffect: "non-scaling-stroke" }),
  /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(import_primitives8.Circle, { cx: "12", cy: "12.5", r: "3", fill: "currentColor", vectorEffect: "non-scaling-stroke" })
] });

// packages/icons/build-module/library/unseen.mjs
var import_primitives9 = __toESM(require_primitives(), 1);
var import_jsx_runtime32 = __toESM(require_jsx_runtime(), 1);
var unseen_default = /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)(import_primitives9.SVG, { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", style: { fill: "none" }, stroke: "currentColor", strokeWidth: "1.5", children: [
  /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(import_primitives9.Path, { d: "M8 21L10.6587 15.1842M13.1523 9.72929L13.8553 8.19144L16 3.5M20.0645 13C19.2118 11.2841 17.8276 9.87898 16.1272 9M3.93555 13C5.40825 10.0366 8.46631 8 12 8C12.636 8 13.2566 8.06597 13.8553 8.19144M13.1523 9.72929C12.7975 9.58156 12.4083 9.5 12 9.5C10.3431 9.5 9 10.8431 9 12.5C9 13.6747 9.67519 14.6917 10.6587 15.1842M13.1523 9.72929L10.6587 15.1842M13.1755 15.261C14.2481 14.8037 15 13.7397 15 12.5C15 12.1819 14.9505 11.8753 14.8587 11.5876", vectorEffect: "non-scaling-stroke" }),
  /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(import_primitives9.Path, { d: "M12 9.5C10.3431 9.5 9 10.8431 9 12.5C9 13.6747 9.67519 14.6917 10.6587 15.1842L13.1523 9.72929C12.7975 9.58156 12.4083 9.5 12 9.5Z", fill: "currentColor", vectorEffect: "non-scaling-stroke" })
] });
...
function useKeyboardShortcutProps({
  ...
  const generatedDescriptionId = (0, import_element17.useId)();
...
var Button3 = (0, import_element18.forwardRef)(
  function Button22({
    ...
    const mergedClassName = clsx_default(
      ...
      variant !== "unstyled" && style_default4.button,
      style_default4[`is-${tone}`],
      style_default4[`is-${variant}`],
      style_default4[`is-${size4}`],
      loading && style_default4["is-loading"],
      className
    );
...
function Nav(props) {
  ...
  const handleNextClick = (0, import_react17.useCallback)((e) => {
    if (nextMonth) {
      onNextClick?.(e);
    }
  }, [nextMonth, onNextClick]);
  const handlePreviousClick = (0, import_react17.useCallback)((e) => {
    if (previousMonth) {
      onPreviousClick?.(e);
    }
...
function DayPicker(initialProps) {
  ...
  const handleDayClick = (0, import_react34.useCallback)((day, m2) => (e) => {
    e.preventDefault();
    e.stopPropagation();
    setFocused(day);
    if (m2.disabled) {
  ...
  const handleDayFocus = (0, import_react34.useCallback)((day, m2) => (e) => {
    setFocused(day);
    onDayFocus?.(day.date, m2, e);
  }, [onDayFocus, setFocused]);
  const handleDayBlur = (0, import_react34.useCallback)((day, m2) => (e) => {
    blur();
    onDayBlur?.(day.date, m2, e);
  }, [blur, onDayBlur]);
  const handleDayKeyDown = (0, import_react34.useCallback)((day, modifiers) => (e) => {
    const keyMap = {
      ArrowLeft: [
  ...
  const handleDayMouseEnter = (0, import_react34.useCallback)((day, modifiers) => (e) => {
    onDayMouseEnter?.(day.date, modifiers, e);
  }, [onDayMouseEnter]);
  const handleDayMouseLeave = (0, import_react34.useCallback)((day, modifiers) => (e) => {
    onDayMouseLeave?.(day.date, modifiers, e);
  }, [onDayMouseLeave]);
  const handleMonthChange = (0, import_react34.useCallback)((date, monthOffset) => (e) => {
    const selectedMonth = Number(e.target.value);
    const month = dateLib.setMonth(dateLib.startOfMonth(date), selectedMonth);
    goToMonth(dateLib.addMonths(month, -monthOffset));
  }, [dateLib, goToMonth]);
  const handleYearChange = (0, import_react34.useCallback)((date, monthOffset) => (e) => {
...
if (typeof process === "undefined" || true) {
  registerStyle7("c5cdafb1bc", "@layer wp-ui{@layer utilities, components, compositions, overrides;@layer compositions{._28cfdc260e755391__icon-button{--wp-ui-button-aspect-ratio:1;--wp-ui-button-padding-inline:0px;--wp-ui-button-min-width:unset}.f1c70d719989a85a__icon{margin:-1px}}}");
}
...
var IconButton = (0, import_element20.forwardRef)(
  function IconButton2({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime37.jsxs)(Root, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime37.jsxs)(
        Trigger,
        {
          ...
          className: classes,
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(Icon, { icon, size: 24, className: style_default6.icon }),
            shortcut && descriptionId && /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
      ...
      /* @__PURE__ */ (0, import_jsx_runtime37.jsxs)(Popup, { positioner, children: [
        ...
        shortcut && /* @__PURE__ */ (0, import_jsx_runtime37.jsxs)(import_jsx_runtime37.Fragment, { children: [
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(KeyboardShortcutDisplay, { shortcut })
        ] })
      ] })
    ] });
  }
...
var RootContext = (0, import_element21.createContext)({});
...
var PreviewDashStartAndEnd = () => {
  return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
    "svg",
    {
      ...
      strokeWidth: "1",
      children: /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("path", { d: "M29.5,0.5 h-27 a2,2 0 0 0 -2,2 v27 a2,2 0 0 0 2,2 h27 a2,2 0 0 0 2,-2 v-27 a2,2 0 0 0 -2,-2" })
    }
  );
};
var PreviewDashStart = () => {
  return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
    "svg",
    {
      ...
      strokeWidth: "1",
      children: /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("path", { d: "M32,0.5 h-29.5 a2,2 0 0 0 -2,2 v27 a2,2 0 0 0 2,2 h30" })
    }
  );
};
var PreviewDashMiddle = () => {
  return /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)(
    "svg",
    {
      ...
      strokeWidth: "1",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("line", { x1: "0", y1: "0.5", x2: "100", y2: "0.5" }),
        /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("line", { x1: "0", y1: "31.5", x2: "100", y2: "31.5" })
      ]
    }
  );
};
var PreviewDashEnd = () => {
  return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
    "svg",
    {
      ...
      strokeDashoffset: "1.9226",
      strokeWidth: "1",
      children: /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("path", { d: "M0,0.5 h29.5 a2,2 0 0 1 2,2 v27 a2,2 0 0 1 -2,2 h-29.5" })
    }
  );
};
function Day2(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)("td", { ...tdProps, children: [
    PreviewDash && /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(PreviewDash, {}),
    children
  ] });
}
function Root3({ rootRef, ...props }) {
  const { render: render4, ref, role, defaultAriaLabel } = (0, import_element22.useContext)(RootContext);
...
function PreviousMonthButton2(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(NavButton, { ...props, icon: chevron_left_default });
}
function NextMonthButton2(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(NavButton, { ...props, icon: chevron_right_default });
}
...
var CLASSNAMES = {
  root: clsx_default(style_default7.root, resets_default3["box-sizing"]),
  day: style_default7.day,
  day_button: clsx_default(
    style_default7["day-button"],
    global_css_defense_default2.button,
    focus_module_default2["outset-ring--focus-visible"]
  ),
  outside: style_default7.outside,
  caption_label: style_default7["caption-label"],
  button_next: style_default7["nav-button"],
  button_previous: style_default7["nav-button"],
  nav: style_default7.nav,
  month_caption: style_default7["month-caption"],
  months: style_default7.months,
  month_grid: style_default7["month-grid"],
  weekday: style_default7.weekday,
  today: style_default7.today,
  selected: style_default7.selected,
  /*
   ...
   */
  disabled: void 0,
  hidden: style_default7.hidden,
  range_start: style_default7["range-start"],
  range_end: style_default7["range-end"],
  range_middle: style_default7["range-middle"],
  weeks_before_enter: style_default7["weeks-before-enter"],
  weeks_before_exit: style_default7["weeks-before-exit"],
  weeks_after_enter: style_default7["weeks-after-enter"],
  weeks_after_exit: style_default7["weeks-after-exit"],
  caption_after_enter: style_default7["caption-after-enter"],
  caption_after_exit: style_default7["caption-after-exit"],
  caption_before_enter: style_default7["caption-before-enter"],
  caption_before_exit: style_default7["caption-before-exit"]
};
var MODIFIER_CLASSNAMES = {
  preview: style_default7.preview
};
var COMMON_PROPS = {
  animate: true,
...
function useControlledValue2({
  ...
  const [state, setState] = (0, import_element23.useState)(initialValue);
  const value = hasValue ? valueProp : state;
  const uncontrolledSetValue = (0, import_element23.useCallback)(
    (nextValue, ...args) => {
      setState(nextValue);
...
function usePreserveDayFocus(forwardedRef, month) {
  const rootRef = (0, import_element25.useRef)(null);
  const hadDayFocusRef = (0, import_element25.useRef)(false);
  ...
  const onDayFocus = (0, import_element25.useCallback)(() => {
    hadDayFocusRef.current = true;
  }, []);
  const onDayBlur = (0, import_element25.useCallback)(() => {
...
var Calendar = (0, import_element26.forwardRef)(
  function Calendar2({
    ...
    const rootContextValue = (0, import_element26.useMemo)(
      () => ({
        render: render4,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(RootContext.Provider, { value: rootContextValue, children: /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(
      DayPicker,
      {
        ...COMMON_PROPS,
        ...localizationProps,
...
var RangeCalendar = (0, import_element27.forwardRef)(
  function RangeCalendar2({
    ...
    const dayFocusProps = usePreserveDayFocus(ref, month);
    const [hoveredDate, setHoveredDate] = (0, import_element27.useState)(
      void 0
    );
    ...
    const modifiers = (0, import_element27.useMemo)(() => {
      return {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(RootContext.Provider, { value: rootContextValue, children: /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(
      DayPicker,
      {
        ...COMMON_PROPS,
        ...localizationProps,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime41.jsxs)(
      "div",
      {
        ...
        className: clsx_default(
          ...
          style_default9["input-layout"],
          style_default9[`is-size-${size4}`],
          visuallyDisabled && style_default9["is-disabled"],
          isBorderless && style_default9["is-borderless"],
          className
        ),
        ...restProps,
        children: [
          import_element29.Children.count(prefix) > 0 && /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(
            "div",
            {
              className: style_default9["slot-wrapper"],
              "data-slot-type": "prefix",
              children: prefix
            }
          ),
          children,
          import_element29.Children.count(suffix) > 0 && /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(
            "div",
            {
              className: style_default9["slot-wrapper"],
...
var InputLayoutSlot = (0, import_element30.forwardRef)(function InputLayoutSlot2({ padding = "default", className, ...restProps }, ref) {
  return /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(
    "div",
    {
      ref,
      className: clsx_default(
        style_default10["input-layout-slot"],
        style_default10[`is-padding-${padding}`],
        className
      ),
      ...restProps
    }
...
var Spinner = (0, import_element32.forwardRef)(
  function Spinner2({ className, ...props }, ref) {
    return /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)(
      "svg",
      {
        className: clsx_default(style_default12.spinner, className),
        viewBox: "0 0 100 100",
        xmlns: "http://www.w3.org/2000/svg",
        role: "presentation",
        focusable: "false",
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(
            "circle",
            {
              className: style_default12.track,
              cx: "50",
              cy: "50",
              r: "50",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(
            "path",
            {
              className: style_default12.indicator,
...
var style_default13 = { "indicator": "_7a7ac88e306348e7__indicator", "indicator-jump": "_48722cc5dd090ce4__indicator-jump", "is-invalid": "_57a3bbbfbe38a5c6__is-invalid", "is-valid": "_9e944dc198aac10b__is-valid", "indicator-icon": "e482806667437c6a__indicator-icon", "indicator-spinner": "_6e46434cc23019d2__indicator-spinner" };
var ICON = {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime45.jsxs)(
    "p",
    {
      ...
      className: clsx_default(
        ...
        style_default13.indicator,
        style_default13[`is-${type}`]
      ),
      children: [
        type === "validating" ? /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(Spinner, { className: style_default13["indicator-spinner"] }) : /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(
          Icon,
          {
            className: style_default13["indicator-icon"],
            icon: ICON[type],
            size: 16,
            fill: "currentColor"
          }
...
var DEFAULT_RENDER = (props) => /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(Stack, { ...props, direction: "column", gap: "sm" });
...
var ControlWithError = (0, import_element33.forwardRef)(function ControlWithError2({
  ...
  const [errorMessage, setErrorMessage] = (0, import_element33.useState)();
  const [statusMessage, setStatusMessage] = (0, import_element33.useState)();
  const [showMessage, setShowMessage] = (0, import_element33.useState)(false);
  const [isTouched, setIsTouched] = (0, import_element33.useState)(false);
  const wrapperRef = (0, import_element33.useRef)(null);
  ...
  const messageId = (0, import_element33.useId)();
  const message2 = (() => {
    if (errorMessage) {
  ...
  return useRender({
    ...
    props: mergeProps(restProps, {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime46.jsxs)(import_jsx_runtime46.Fragment, { children: [
        (0, import_element33.cloneElement)(children, {
...
var Label = (0, import_element36.forwardRef)(
  function Label2({ className, hideFromVision, variant, ...restProps }, ref) {
    ...
    if (hideFromVision) {
      return /* @__PURE__ */ (0, import_jsx_runtime49.jsx)(VisuallyHidden, { render: label });
    }
    return label;
  }
);
...
if (typeof process === "undefined" || true) {
  registerStyle18("df33c48b2d", '@layer wp-ui{@layer utilities, components, compositions, overrides;@layer utilities{._2d5ad850b2f90964__label{--wp-ui-field-label-line-height:var(--wpds-typography-line-height-xs,16px);color:var(--wpds-color-foreground-content-neutral,#1e1e1e);font-family:var(--wpds-typography-font-family-body,-apple-system,system-ui,"Segoe UI","Roboto","Oxygen-Sans","Ubuntu","Cantarell","Helvetica Neue",sans-serif);font-size:var(--wpds-typography-font-size-xs,11px);font-weight:var(--wpds-typography-font-weight-emphasis,600);line-height:var(--wp-ui-field-label-line-height);text-transform:uppercase;&._17c4214649230bea__is-plain{font-size:var(--wpds-typography-font-size-md,13px);font-weight:var(--wpds-typography-font-weight-default,400);text-transform:none}}._08a3750500e0233f__description{--_gcd-p-font-size:var(--wpds-typography-font-size-sm,12px);--_gcd-p-line-height:var(--wpds-typography-line-height-xs,16px);--_gcd-p-margin:0;text-wrap:pretty;color:var(--wpds-color-foreground-content-neutral-weak,#707070);font-family:var(--wpds-typography-font-family-body,-apple-system,system-ui,"Segoe UI","Roboto","Oxygen-Sans","Ubuntu","Cantarell","Helvetica Neue",sans-serif);font-size:var(--wpds-typography-font-size-sm,12px);line-height:var(--wpds-typography-line-height-xs,16px)}}}');
}
...
if (typeof process === "undefined" || true) {
  registerStyle19("df33c48b2d", '@layer wp-ui{@layer utilities, components, compositions, overrides;@layer utilities{._2d5ad850b2f90964__label{--wp-ui-field-label-line-height:var(--wpds-typography-line-height-xs,16px);color:var(--wpds-color-foreground-content-neutral,#1e1e1e);font-family:var(--wpds-typography-font-family-body,-apple-system,system-ui,"Segoe UI","Roboto","Oxygen-Sans","Ubuntu","Cantarell","Helvetica Neue",sans-serif);font-size:var(--wpds-typography-font-size-xs,11px);font-weight:var(--wpds-typography-font-weight-emphasis,600);line-height:var(--wp-ui-field-label-line-height);text-transform:uppercase;&._17c4214649230bea__is-plain{font-size:var(--wpds-typography-font-size-md,13px);font-weight:var(--wpds-typography-font-weight-default,400);text-transform:none}}._08a3750500e0233f__description{--_gcd-p-font-size:var(--wpds-typography-font-size-sm,12px);--_gcd-p-line-height:var(--wpds-typography-line-height-xs,16px);--_gcd-p-margin:0;text-wrap:pretty;color:var(--wpds-color-foreground-content-neutral-weak,#707070);font-family:var(--wpds-typography-font-family-body,-apple-system,system-ui,"Segoe UI","Roboto","Oxygen-Sans","Ubuntu","Cantarell","Helvetica Neue",sans-serif);font-size:var(--wpds-typography-font-size-sm,12px);line-height:var(--wpds-typography-line-height-xs,16px)}}}');
}
...
if (typeof process === "undefined" || true) {
  registerStyle20("1540cbc709", "@layer wp-ui{@layer utilities, components, compositions, overrides;@layer components{._1e441c22c9dc5d28__wrapper{--wp-ui-textarea-min-height:var(--wpds-dimension-size-lg,40px)}._414844876c32ecee__textarea{min-height:calc(var(--wp-ui-textarea-min-height) - 2px);resize:block}}@layer compositions{._1e441c22c9dc5d28__wrapper{--wp-ui-input-padding-block:9.9px;height:auto;line-height:1.4}}}");
}
var style_default14 = { "wrapper": "_1e441c22c9dc5d28__wrapper", "textarea": "_414844876c32ecee__textarea" };
if (typeof process === "undefined" || true) {
...
var wrappedRender = (render4, restProps) => {
  return function textareaRender(props) {
    return typeof render4 === "function" ? render4(mergeProps(props, restProps)) : (0, import_element41.cloneElement)(render4, mergeProps(props, restProps));
  };
};
var Textarea = (0, import_element41.forwardRef)(
  function Textarea2({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime53.jsx)(
      Input3,
      {
        className: clsx_default(style_default14.wrapper, className),
        style,
        render: wrappedRender(
          render4 || ((props) => /* @__PURE__ */ (0, import_jsx_runtime53.jsx)("textarea", { ...props })),
          {
            className: clsx_default(
              global_css_defense_default7.textarea,
              style_default14.textarea
            ),
            ref,
            rows,
            ...restProps
...
var InputControl = (0, import_element42.forwardRef)(
  function InputControl2({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime54.jsxs)(field_exports.Root, { className: clsx_default(style_default15.root, className), children: [
      /* @__PURE__ */ (0, import_jsx_runtime54.jsx)(field_exports.Label, { hideFromVision: hideLabelFromVision, children: label }),
      /* @__PURE__ */ (0, import_jsx_runtime54.jsx)(Input3, { ref, ...restProps }),
      description && /* @__PURE__ */ (0, import_jsx_runtime54.jsx)(field_exports.Description, { children: description }),
      details && /* @__PURE__ */ (0, import_jsx_runtime54.jsx)(field_exports.Details, { children: details })
    ] });
  }
);
...
var TextareaControl = (0, import_element43.forwardRef)(function TextareaControl2({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime55.jsxs)(field_exports.Root, { className, children: [
    /* @__PURE__ */ (0, import_jsx_runtime55.jsx)(field_exports.Label, { hideFromVision: hideLabelFromVision, children: label }),
    /* @__PURE__ */ (0, import_jsx_runtime55.jsx)(Textarea, { ref, ...restProps }),
    description && /* @__PURE__ */ (0, import_jsx_runtime55.jsx)(field_exports.Description, { children: description }),
    details && /* @__PURE__ */ (0, import_jsx_runtime55.jsx)(field_exports.Details, { children: details })
  ] });
});
...
var ValidatedInputControl = (0, import_element44.forwardRef)(function ValidatedInputControl2({ required, markWhenOptional, customValidity, ...restProps }, forwardedRef) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime56.jsx)(
    ControlWithError,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime56.jsx)(InputControl, { ref: mergedRefs, ...restProps })
    }
  );
});
...
var ValidatedTextareaControl = (0, import_element45.forwardRef)(function ValidatedTextareaControl2({ required, markWhenOptional, customValidity, ...restProps }, forwardedRef) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime57.jsx)(
    ControlWithError,
    {
      ...
      customValidity,
      getValidityTarget: () => validityTargetRef.current,
      children: /* @__PURE__ */ (0, import_jsx_runtime57.jsx)(TextareaControl, { ref: mergedRefs, ...restProps })
    }
  );
});
...
function useElements({
  ...
  const [records, setRecords] = (0, import_element46.useState)(staticElements);
...
var OPERATORS = [
  {
    ...
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("Includes"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
        /* translators: 1: Filter name (e.g. "Author"). 2: Filter value (e.g. "Admin"): "Author is any: Admin, Editor". */
        (0, import_i18n9.__)("<Name>%1$s includes: </Name><Value>%2$s</Value>"),
        filter.name,
        activeElements.map((element) => element.label).join(", ")
      ),
      filterTextWrappers
  ...
  },
  {
    ...
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("Includes all"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
        /* translators: 1: Filter name (e.g. "Author"). 2: Filter value (e.g. "Admin"): "Author includes all: Admin, Editor". */
        (0, import_i18n9.__)("<Name>%1$s includes all: </Name><Value>%2$s</Value>"),
        filter.name,
        activeElements.map((element) => element.label).join(", ")
      ),
      filterTextWrappers
  ...
  },
  {
    ...
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("Between (inc)"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
  ...
  },
  {
    ...
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("In the past"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
  ...
  },
  {
    name: OPERATOR_OVER,
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("Over"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
        /* translators: 1: Filter name (e.g. "Date"). 2: Filter value (e.g. "7 days"): "Date is over: 7 days". */
        (0, import_i18n9.__)("<Name>%1$s is over: </Name><Value>%2$s</Value>"),
        filter.name,
        `${activeElements[0].value.value} ${activeElements[0].value.unit}`
      ),
      filterTextWrappers
  ...
  },
  {
    name: OPERATOR_IS,
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("Is"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
        /* translators: 1: Filter name (e.g. "Author"). 2: Filter value (e.g. "Admin"): "Author is: Admin". */
        (0, import_i18n9.__)("<Name>%1$s is: </Name><Value>%2$s</Value>"),
        filter.name,
  ...
  },
  {
    ...
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("Is not"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
        /* translators: 1: Filter name (e.g. "Author"). 2: Filter value (e.g. "Admin"): "Author is not: Admin". */
        (0, import_i18n9.__)("<Name>%1$s is not: </Name><Value>%2$s</Value>"),
        filter.name,
        activeElements[0].label
      ),
      filterTextWrappers
  ...
  },
  {
    ...
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("Less than"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
        /* translators: 1: Filter name (e.g. "Count"). 2: Filter value (e.g. "10"): "Count is less than: 10". */
        (0, import_i18n9.__)("<Name>%1$s is less than: </Name><Value>%2$s</Value>"),
        filter.name,
        activeElements[0].label
      ),
      filterTextWrappers
  ...
  },
  {
    ...
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("Greater than"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
  ...
  },
  {
    ...
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("Less than or equal"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
  ...
  },
  {
    ...
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("Greater than or equal"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
  ...
  },
  {
    ...
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("Before"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
        /* translators: 1: Filter name (e.g. "Date"). 2: Filter value (e.g. "2024-01-01"): "Date is before: 2024-01-01". */
        (0, import_i18n9.__)("<Name>%1$s is before: </Name><Value>%2$s</Value>"),
        filter.name,
        activeElements[0].label
      ),
      filterTextWrappers
  ...
  },
  {
    name: OPERATOR_AFTER,
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("After"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
        /* translators: 1: Filter name (e.g. "Date"). 2: Filter value (e.g. "2024-01-01"): "Date is after: 2024-01-01". */
        (0, import_i18n9.__)("<Name>%1$s is after: </Name><Value>%2$s</Value>"),
        filter.name,
        activeElements[0].label
      ),
      filterTextWrappers
  ...
  },
  {
    ...
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("Before (inc)"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
  ...
  },
  {
    ...
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("After (inc)"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
  ...
  },
  {
    ...
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("Contains"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
        /* translators: 1: Filter name (e.g. "Title"). 2: Filter value (e.g. "Hello"): "Title contains: Hello". */
        (0, import_i18n9.__)("<Name>%1$s contains: </Name><Value>%2$s</Value>"),
        filter.name,
        activeElements[0].label
      ),
      filterTextWrappers
  ...
  },
  {
    ...
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("Doesn't contain"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
  ...
  },
  {
    ...
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("Starts with"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
        /* translators: 1: Filter name (e.g. "Title"). 2: Filter value (e.g. "Hello"): "Title starts with: Hello". */
        (0, import_i18n9.__)("<Name>%1$s starts with: </Name><Value>%2$s</Value>"),
        filter.name,
        activeElements[0].label
      ),
      filterTextWrappers
  ...
  },
  {
    ...
    /* translators: DataViews operator name */
    label: (0, import_i18n9.__)("Not on"),
    filterText: (filter, activeElements) => (0, import_element47.createInterpolateElement)(
      (0, import_i18n9.sprintf)(
...
var ValidatedCheckboxControl = (0, import_element48.forwardRef)(UnforwardedValidatedCheckboxControl);
  ...
  return (
    ...
    /* @__PURE__ */ (0, import_jsx_runtime60.jsx)(
      ControlWithError,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime60.jsx)(import_components3.ComboboxControl, { ...restProps })
      }
    )
  );
};
var ValidatedComboboxControl = (0, import_element49.forwardRef)(UnforwardedValidatedComboboxControl);
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(
          ControlWithError,
          {
            ...
            customValidity,
            getValidityTarget: () => validityTargetRef.current,
            children: /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(import_components4.FormTokenField, { ...restProps })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(
          "input",
...
var ValidatedFormTokenField = (0, import_element50.forwardRef)(UnforwardedValidatedFormTokenField);
...
var UnforwardedValidatedNumberControl = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime62.jsx)(
    ControlWithError,
    {
      ...
      customValidity,
      getValidityTarget: () => validityTargetRef.current,
      children: /* @__PURE__ */ (0, import_jsx_runtime62.jsx)(import_components5.__experimentalNumberControl, { ref: mergedRefs, ...restProps })
    }
  );
};
var ValidatedNumberControl = (0, import_element51.forwardRef)(UnforwardedValidatedNumberControl);
...
var UnforwardedValidatedRadioControl = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime63.jsx)(
    ControlWithError,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime63.jsx)(import_components6.RadioControl, { ...restProps })
    }
  );
};
var ValidatedRadioControl = (0, import_element52.forwardRef)(UnforwardedValidatedRadioControl);
...
var ValidatedSelectControl = (0, import_element53.forwardRef)(UnforwardedValidatedSelectControl);
...
var ValidatedToggleControl = (0, import_element54.forwardRef)(UnforwardedValidatedToggleControl);
...
var UnforwardedValidatedToggleGroupControl = ({
  ...
  const nameAttr = (0, import_element55.useId)();
  return /* @__PURE__ */ (0, import_jsx_runtime66.jsxs)("div", { className: "dataviews-validated-control__wrapper-with-error-delegate", children: [
    /* @__PURE__ */ (0, import_jsx_runtime66.jsx)(
      ControlWithError,
      {
        ...
        customValidity,
        getValidityTarget: () => validityTargetRef.current,
        children: /* @__PURE__ */ (0, import_jsx_runtime66.jsx)(import_components9.__experimentalToggleGroupControl, { ref: forwardedRef, ...restProps })
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime66.jsx)(
      "input",
...
var ValidatedToggleGroupControl = (0, import_element55.forwardRef)(UnforwardedValidatedToggleGroupControl);
...
function Combobox({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime68.jsx)(import_components10.Spinner, {});
  }
...
var TIME_UNITS_OPTIONS = {
  [OPERATOR_IN_THE_PAST]: [
    { value: "days", label: (0, import_i18n10.__)("Days") },
    { value: "weeks", label: (0, import_i18n10.__)("Weeks") },
    { value: "months", label: (0, import_i18n10.__)("Months") },
    { value: "years", label: (0, import_i18n10.__)("Years") }
  ],
  [OPERATOR_OVER]: [
    { value: "days", label: (0, import_i18n10.__)("Days ago") },
    { value: "weeks", label: (0, import_i18n10.__)("Weeks ago") },
    { value: "months", label: (0, import_i18n10.__)("Months ago") },
    { value: "years", label: (0, import_i18n10.__)("Years ago") }
  ]
};
function RelativeDateControl({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime69.jsx)(
    import_components11.BaseControl,
    {
      ...
      hideLabelFromVision,
      help: description,
      children: /* @__PURE__ */ (0, import_jsx_runtime69.jsxs)(Stack, { direction: "row", gap: "sm", children: [
...
function getTimezoneDescription() {
  ...
  if ("UTC" === timezone.string) {
    timezoneDetail = (0, import_i18n11.__)("Coordinated Universal Time");
...
function CalendarDateTimeControl({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime70.jsx)(
    import_components12.BaseControl,
    {
      ...
      help: description,
      hideLabelFromVision,
      children: /* @__PURE__ */ (0, import_jsx_runtime70.jsxs)(Stack, { direction: "column", gap: "lg", children: [
        ...
        !compact && /* @__PURE__ */ (0, import_jsx_runtime70.jsx)(
          Calendar,
          {
            style: { width: "100%" },
...
function ValidatedDateControl({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime71.jsxs)(Stack, { direction: "column", gap: "sm", onBlur, children: [
    children,
    customValidity && /* @__PURE__ */ (0, import_jsx_runtime71.jsx)(
      ValidityIndicator,
      {
...
function AdaptiveSelect(props) {
  ...
  if (elements.length >= ELEMENTS_THRESHOLD) {
    return /* @__PURE__ */ (0, import_jsx_runtime73.jsx)(Combobox, { ...props });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime73.jsx)(Select2, { ...props });
}
...
function ValidatedText({
  ...
  const value = getValue({ item: data });
  const disabled2 = field.isDisabled({ item: data, field });
  const onValueChangeControl = (0, import_element63.useCallback)(
    (newValue) => onChange(
      setValue({
        item: data,
        value: newValue
...
function BetweenControls({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime78.jsx)(
    import_components15.BaseControl,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime78.jsxs)(import_components15.Flex, { direction: "row", gap: 4, children: [
...
function Radio({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime81.jsx)(import_components16.Spinner, {});
  }
...
function BetweenControls2({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime83.jsx)(
    import_components17.BaseControl,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime83.jsxs)(Stack, { direction: "row", gap: "sm", justify: "space-between", children: [
...
function Textarea3({
  ...
  const onValueChangeControl = (0, import_element69.useCallback)(
    (newValue) => onChange(setValue({ item: data, value: newValue })),
    [data, onChange, setValue]
  );
...
function ToggleGroup({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime86.jsx)(import_components18.Spinner, {});
  }
...
function ArrayControl({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime87.jsx)(import_components19.Spinner, {});
  }
    ...
    import_components20.Dropdown,
    {
      ...
      renderToggle: ({ onToggle }) => /* @__PURE__ */ (0, import_jsx_runtime88.jsx)(
        import_components20.Button,
        {
          ...
          disabled: disabled2,
          accessibleWhenDisabled: true,
          icon: () => /* @__PURE__ */ (0, import_jsx_runtime88.jsx)(import_components20.ColorIndicator, { colorValue: validColor })
        }
      ),
      renderContent: () => /* @__PURE__ */ (0, import_jsx_runtime88.jsx)(import_components20.__experimentalDropdownContentWrapper, { paddingSize: "none", children: /* @__PURE__ */ (0, import_jsx_runtime88.jsx)(
...
function Password({
  ...
  const [isVisible, setIsVisible] = (0, import_element73.useState)(false);
  const disabled2 = field.isDisabled({ item: data, field });
...
async function loadTemplateViewConfig() {
  const config = await unlock3((0, import_data4.resolveSelect)(import_core_data2.store)).getViewConfig(
    "postType",
    TEMPLATE_POST_TYPE
  );
  return {
...
async function ensureView(activeView, search) {
  ...
  return loadView({
    ...
    defaultView,
    defaultLayouts,
    activeViewOverrides: viewList?.find((v2) => v2.slug === slug)?.view ?? {},
    queryParams: search
  });
}
async function loadTemplateFields() {
  await unlock3((0, import_data4.dispatch)(import_editor.store)).registerPostTypeSchema(
    TEMPLATE_POST_TYPE
  );
  return unlock3((0, import_data4.select)(import_editor.store)).getEntityFields(
    "postType",
    TEMPLATE_POST_TYPE
  );
}
...
var route = {
  async beforeLoad() {
    const theme2 = await (0, import_data5.resolveSelect)(import_core_data3.store).getCurrentTheme();
    if (!theme2?.theme_supports?.["block-templates"]) {
      throw notFound();
    }
  },
  title: () => (0, import_i18n24.__)("Templates"),
  async canvas(context) {
    ...
    const template = filterSortAndPaginate(templates ?? [], view, fields).data[0];
    if (template) {
      return {
        postType: "wp_template",
