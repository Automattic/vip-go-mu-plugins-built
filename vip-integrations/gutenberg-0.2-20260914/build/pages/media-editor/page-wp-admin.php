...
global $gutenberg_media_editor_wp_admin_routes, $gutenberg_media_editor_wp_admin_menu_items;
$gutenberg_media_editor_wp_admin_routes     = array();
$gutenberg_media_editor_wp_admin_menu_items = array();
 ...
 */
function gutenberg_register_media_editor_wp_admin_route( $path, $content_module = null, $route_module = null ) {
	global $gutenberg_media_editor_wp_admin_routes;
	...
	$gutenberg_media_editor_wp_admin_routes[] = $route;
}
 ...
 */
function gutenberg_register_media_editor_wp_admin_menu_item( $id, $label, $to, $parent_id = '' ) {
	global $gutenberg_media_editor_wp_admin_menu_items;
	...
	$gutenberg_media_editor_wp_admin_menu_items[] = $menu_item;
}
 ...
 */
function gutenberg_get_media_editor_wp_admin_routes() {
	global $gutenberg_media_editor_wp_admin_routes;
	return $gutenberg_media_editor_wp_admin_routes ?? array();
}
 ...
 */
function gutenberg_get_media_editor_wp_admin_menu_items() {
	global $gutenberg_media_editor_wp_admin_menu_items;
	return $gutenberg_media_editor_wp_admin_menu_items ?? array();
}
 ...
 */
function gutenberg_media_editor_wp_admin_preload_data() {
 ...
 */
function gutenberg_media_editor_wp_admin_enqueue_scripts( $hook_suffix ) {
	...
	gutenberg_media_editor_wp_admin_preload_data();

	// Get all registered routes
	$routes = gutenberg_get_media_editor_wp_admin_routes();
 ...
 */
function gutenberg_media_editor_wp_admin_render_page() {
	?>
	<style>
		...
		body.js #wpbody-content > div:not(#media-editor-wp-admin-app):not(#screen-meta) {
			display: none;
		}
		body.js #wpfooter {
			display: none;
