...
global $gutenberg_options_connectors_wp_admin_routes, $gutenberg_options_connectors_wp_admin_menu_items;
$gutenberg_options_connectors_wp_admin_routes     = array();
$gutenberg_options_connectors_wp_admin_menu_items = array();
 ...
 */
function gutenberg_register_options_connectors_wp_admin_route( $path, $content_module = null, $route_module = null ) {
	global $gutenberg_options_connectors_wp_admin_routes;
	...
	$gutenberg_options_connectors_wp_admin_routes[] = $route;
}
 ...
 */
function gutenberg_register_options_connectors_wp_admin_menu_item( $id, $label, $to, $parent_id = '' ) {
	global $gutenberg_options_connectors_wp_admin_menu_items;
	...
	$gutenberg_options_connectors_wp_admin_menu_items[] = $menu_item;
}
 ...
 */
function gutenberg_get_options_connectors_wp_admin_routes() {
	global $gutenberg_options_connectors_wp_admin_routes;
	return $gutenberg_options_connectors_wp_admin_routes ?? array();
}
 ...
 */
function gutenberg_get_options_connectors_wp_admin_menu_items() {
	global $gutenberg_options_connectors_wp_admin_menu_items;
	return $gutenberg_options_connectors_wp_admin_menu_items ?? array();
}
 ...
 */
function gutenberg_options_connectors_wp_admin_preload_data() {
 ...
 */
function gutenberg_options_connectors_wp_admin_enqueue_scripts( $hook_suffix ) {
	...
	gutenberg_options_connectors_wp_admin_preload_data();

	// Get all registered routes
	$routes = gutenberg_get_options_connectors_wp_admin_routes();
 ...
 */
function gutenberg_options_connectors_wp_admin_render_page() {
	?>
	<style>
...
add_action( 'admin_enqueue_scripts', 'gutenberg_options_connectors_wp_admin_enqueue_scripts' );
