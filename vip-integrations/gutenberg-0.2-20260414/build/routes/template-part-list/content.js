...
function Page({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime101.jsxs)(navigable_region_default, { className: classes, ariaLabel: effectiveAriaLabel, children: [
    (title || breadcrumbs || badges || actions) && /* @__PURE__ */ (0, import_jsx_runtime101.jsx)(
      Header,
      {
        headingLevel,
        breadcrumbs,
...
function CreateTemplatePartModalContents({
  ...
  const [title, setTitle] = (0, import_element59.useState)(defaultTitle);
  const [area, setArea] = (0, import_element59.useState)(defaultArea);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime102.jsx)(
    "form",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime102.jsxs)(import_components47.__experimentalVStack, { spacing: "4", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime102.jsxs)("fieldset", { className: "fields-create-template-part-modal__area-fieldset", children: [
          /* @__PURE__ */ (0, import_jsx_runtime102.jsx)(import_components47.BaseControl.VisualLabel, { as: "legend", children: (0, import_i18n43.__)("Area") }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime102.jsxs)(import_components47.__experimentalHStack, { justify: "right", children: [
          /* @__PURE__ */ (0, import_jsx_runtime102.jsx)(
...
if (typeof document !== "undefined" && true && !document.head.querySelector("style[data-wp-hash='6db2c385e7']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "6db2c385e7");
...
var { Tabs } = unlock3(import_components48.privateApis);
...
function TemplatePartList() {
  ...
  const [showTemplatePartModal, setShowTemplatePartModal] = (0, import_element60.useState)(false);
  const defaultView = DEFAULT_VIEW;
  const activeViewOverrides = (0, import_element60.useMemo)(
  ...
  const postTypeQuery = (0, import_element60.useMemo)(() => viewToQuery(view), [view]);
  const {
    records: posts,
    totalItems,
    totalPages,
