...
if ( ! function_exists( 'gutenberg_register_font_library_wp_admin_route' ) ) {
	/**
	 ...
	 */
	function gutenberg_register_font_library_wp_admin_route( $path, $content_module = null, $route_module = null ) {
...
if ( ! function_exists( 'gutenberg_register_font_library_wp_admin_menu_item' ) ) {
	/**
	 ...
	 */
	function gutenberg_register_font_library_wp_admin_menu_item( $id, $label, $to, $parent_id = '' ) {
...
if ( ! function_exists( 'gutenberg_get_font_library_wp_admin_routes' ) ) {
	/**
	 * Get all registered routes for the font-library-wp-admin page.
	 *
	 * @return array Array of route objects.
	 */
	function gutenberg_get_font_library_wp_admin_routes() {
		global $gutenberg_font_library_wp_admin_routes;
		return $gutenberg_font_library_wp_admin_routes ?? array();
	}
}

if ( ! function_exists( 'gutenberg_get_font_library_wp_admin_menu_items' ) ) {
	/**
	 * Get all registered menu items for the font-library-wp-admin page.
	 *
	 * @return array Array of menu item objects.
	 */
	function gutenberg_get_font_library_wp_admin_menu_items() {
		global $gutenberg_font_library_wp_admin_menu_items;
		return $gutenberg_font_library_wp_admin_menu_items ?? array();
	}
}

if ( ! function_exists( 'gutenberg_font_library_wp_admin_preload_data' ) ) {
	/**
	 * Preload REST API data for the font-library-wp-admin page.
	 * Automatically called during page rendering.
	 */
	function gutenberg_font_library_wp_admin_preload_data() {
...
if ( ! function_exists( 'gutenberg_font_library_wp_admin_enqueue_scripts' ) ) {
	/**
	 ...
	 */
	function gutenberg_font_library_wp_admin_enqueue_scripts( $hook_suffix ) {
		...
		gutenberg_font_library_wp_admin_preload_data();

		// Get all registered routes
		$routes = gutenberg_get_font_library_wp_admin_routes();
...
if ( ! function_exists( 'gutenberg_font_library_wp_admin_render_page' ) ) {
	/**
	 * Render the font-library-wp-admin page.
	 * Call this function from add_menu_page or add_submenu_page.
	 * This renders within the normal WordPress admin interface.
	 */
	function gutenberg_font_library_wp_admin_render_page() {
		?>
		<style>
...
add_action( 'admin_enqueue_scripts', 'gutenberg_font_library_wp_admin_enqueue_scripts' );
