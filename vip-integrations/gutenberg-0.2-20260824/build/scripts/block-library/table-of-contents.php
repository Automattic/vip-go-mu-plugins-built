 ...
 * @return string The content of the block being rendered.
 */
function gutenberg_block_core_table_of_contents_render( $attributes, $content, $block = null ) {
	...
	if ( '' !== trim( $legacy_content ) ) {
		return gutenberg_block_core_table_of_contents_add_aria_label( $attributes, $legacy_content );
	}
