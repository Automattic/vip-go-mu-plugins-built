...
global $gutenberg_guidelines_wp_admin_routes, $gutenberg_guidelines_wp_admin_menu_items;
$gutenberg_guidelines_wp_admin_routes     = array();
$gutenberg_guidelines_wp_admin_menu_items = array();
 ...
 */
function gutenberg_register_guidelines_wp_admin_route( $path, $content_module = null, $route_module = null ) {
	global $gutenberg_guidelines_wp_admin_routes;
	...
	$gutenberg_guidelines_wp_admin_routes[] = $route;
}
 ...
 */
function gutenberg_register_guidelines_wp_admin_menu_item( $id, $label, $to, $parent_id = '' ) {
	global $gutenberg_guidelines_wp_admin_menu_items;
	...
	$gutenberg_guidelines_wp_admin_menu_items[] = $menu_item;
}
 ...
 */
function gutenberg_get_guidelines_wp_admin_routes() {
	global $gutenberg_guidelines_wp_admin_routes;
	return $gutenberg_guidelines_wp_admin_routes ?? array();
}
 ...
 */
function gutenberg_get_guidelines_wp_admin_menu_items() {
	global $gutenberg_guidelines_wp_admin_menu_items;
	return $gutenberg_guidelines_wp_admin_menu_items ?? array();
}
 ...
 */
function gutenberg_guidelines_wp_admin_preload_data() {
 ...
 */
function gutenberg_guidelines_wp_admin_enqueue_scripts( $hook_suffix ) {
	...
	gutenberg_guidelines_wp_admin_preload_data();

	// Get all registered routes
	$routes = gutenberg_get_guidelines_wp_admin_routes();
 ...
 */
function gutenberg_guidelines_wp_admin_render_page() {
	?>
	<style>
		...
		body.js #wpbody-content > div:not(#guidelines-wp-admin-app):not(#screen-meta) {
			display: none;
		}
		body.js #wpfooter {
			display: none;
	...
	<div id="guidelines-wp-admin-app"></div>
	<?php
}

// Hook the enqueue function to admin_enqueue_scripts
add_action( 'admin_enqueue_scripts', 'gutenberg_guidelines_wp_admin_enqueue_scripts' );
