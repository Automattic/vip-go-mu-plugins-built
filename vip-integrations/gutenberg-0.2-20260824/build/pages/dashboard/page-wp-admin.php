...
function gutenberg_dashboard_wp_admin_render_page() {
	...
	<style>
		...
		body.js #wpbody-content > div:not(#dashboard-wp-admin-app):not(#screen-meta) {
			display: none;
		}
		body.js #wpfooter {
			display: none;
	...
	<div id="dashboard-wp-admin-app"></div>
	<?php
}
