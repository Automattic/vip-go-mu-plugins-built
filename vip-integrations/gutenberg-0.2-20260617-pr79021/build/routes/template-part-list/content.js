...
function ViewPickerActivity({
  ...
  const { itemListLabel, paginationInfo } = (0, import_element39.useContext)(dataviews_context_default);
  const isMultiselect = useIsMultiselectPicker(actions);
  const titleField = fields.find(
    (field) => field.id === view?.titleField
  );
...
function createStoreContext(providers = [], scopedProviders = []) {
  ...
  const ContextProvider = (props) => {
    return providers.reduceRight(
      (children, Provider2) => /* @__PURE__ */ (0, import_jsx_runtime69.jsx)(Provider2, { ...props, children }),
...
var useComposite = createHook(
  function useComposite2({
    ...
    props = useWrapElement(
      props,
      (element) => /* @__PURE__ */ (0, import_jsx_runtime71.jsx)(CompositeContextProvider, { value: store, children: element }),
      [store]
    );
...
var useDisclosureContent = createHook(function useDisclosureContent2({ store, alwaysVisible, ...props }) {
  ...
  props = useWrapElement(
    props,
    (element) => /* @__PURE__ */ (0, import_jsx_runtime72.jsx)(DialogScopedContextProvider, { value: store, children: element }),
    [store]
  );
...
var useComboboxList = createHook(
  function useComboboxList2({ store, alwaysVisible, ...props }) {
    ...
    props = useWrapElement(
      props,
      (element) => /* @__PURE__ */ (0, import_jsx_runtime75.jsx)(ComboboxScopedContextProvider, { value: store, children: /* @__PURE__ */ (0, import_jsx_runtime75.jsx)(ComboboxListRoleContext.Provider, { value: role, children: element }) }),
      [store, role]
    );
...
function ComboboxProvider(props = {}) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime76.jsx)(ComboboxContextProvider, { value: store, children: props.children });
}
...
function ArrayControl({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime109.jsx)(import_components43.Spinner, {});
  }
    ...
    import_components44.Dropdown,
    {
      ...
      renderToggle: ({ onToggle }) => /* @__PURE__ */ (0, import_jsx_runtime110.jsx)(
        import_components44.Button,
        {
          ...
          disabled: disabled2,
          accessibleWhenDisabled: true,
          icon: () => /* @__PURE__ */ (0, import_jsx_runtime110.jsx)(import_components44.ColorIndicator, { colorValue: validColor })
        }
      ),
      renderContent: () => /* @__PURE__ */ (0, import_jsx_runtime110.jsx)(import_components44.__experimentalDropdownContentWrapper, { paddingSize: "none", children: /* @__PURE__ */ (0, import_jsx_runtime110.jsx)(
...
function Color({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime110.jsx)(
    ValidatedInputControl3,
    {
      ...
      type: "text",
      disabled: disabled2,
      prefix: /* @__PURE__ */ (0, import_jsx_runtime110.jsx)(import_components44.__experimentalInputControlPrefixWrapper, { variant: "control", children: /* @__PURE__ */ (0, import_jsx_runtime110.jsx)(
        ColorPickerDropdown,
        {
          color: value,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime111.jsx)(
    ValidatedText,
    {
      ...{
        ...
        suffix: /* @__PURE__ */ (0, import_jsx_runtime111.jsx)(import_components45.__experimentalInputControlSuffixWrapper, { variant: "control", children: /* @__PURE__ */ (0, import_jsx_runtime111.jsx)(
...
var NavigableRegion = (0, import_element76.forwardRef)(
...
function CreateTemplatePartModal({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime119.jsx)(
    import_components47.Modal,
    {
      ...
      size: "medium",
      children: /* @__PURE__ */ (0, import_jsx_runtime119.jsx)(CreateTemplatePartModalContents, { ...restProps })
    }
  );
}
...
function CreateTemplatePartModalContents({
  ...
  const [title, setTitle] = (0, import_element77.useState)(defaultTitle);
  const [area, setArea] = (0, import_element77.useState)(defaultArea);
  const [isSubmitting, setIsSubmitting] = (0, import_element77.useState)(false);
  const instanceId = (0, import_compose14.useInstanceId)(CreateTemplatePartModal);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime119.jsx)(
    "form",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime119.jsxs)(import_components47.__experimentalVStack, { spacing: "4", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime119.jsxs)("fieldset", { className: "fields-create-template-part-modal__area-fieldset", children: [
          /* @__PURE__ */ (0, import_jsx_runtime119.jsx)(import_components47.BaseControl.VisualLabel, { as: "legend", children: (0, import_i18n44.__)("Area") }),
          /* @__PURE__ */ (0, import_jsx_runtime119.jsx)("div", { className: "fields-create-template-part-modal__area-radio-group", children: (defaultTemplatePartAreas ?? []).map(
            (item) => {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime119.jsxs)(import_components47.__experimentalHStack, { justify: "right", children: [
          /* @__PURE__ */ (0, import_jsx_runtime119.jsx)(
...
if (typeof document !== "undefined" && true && !document.head.querySelector("style[data-wp-hash='ce435fce9a']")) {
  const style = document.createElement("style");
  style.setAttribute("data-wp-hash", "ce435fce9a");
...
function TemplatePartList() {
  ...
  const [showTemplatePartModal, setShowTemplatePartModal] = (0, import_element78.useState)(false);
  const defaultView = DEFAULT_VIEW;
  const activeViewOverrides = (0, import_element78.useMemo)(
  ...
  const postTypeQuery = (0, import_element78.useMemo)(() => viewToQuery(view), [view]);
  const {
    records: posts,
    totalItems,
    totalPages,
  ...
  const fields = (0, import_element78.useMemo)(() => {
  ...
  const cleanupDeletedPostIdsFromUrl = (0, import_element78.useCallback)(
    (deletedItems) => {
  ...
  const handleTabChange = (0, import_element78.useCallback)(
    (areaSlug) => {
      navigate({
