...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React51 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState36 = React51.useState, useEffect31 = React51.useEffect, useLayoutEffect5 = React51.useLayoutEffect, useDebugValue2 = React51.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React51 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore3 = shim.useSyncExternalStore, useRef46 = React51.useRef, useEffect31 = React51.useEffect, useMemo43 = React51.useMemo, useDebugValue2 = React51.useDebugValue;
...
function createStoreContext(providers = [], scopedProviders = []) {
  ...
  const ContextProvider = (props) => {
    return providers.reduceRight(
      (children, Provider2) => /* @__PURE__ */ (0, import_jsx_runtime64.jsx)(Provider2, { ...props, children }),
...
function Header({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime112.jsxs)(Stack, { direction: "column", className: style_default6.header, children: [
...
function CategoryField({ item }) {
  ...
  const categoryLabels = (0, import_element77.useMemo)(() => {
...
function useAugmentPatternsWithPermissions(patterns) {
  const idsAndTypes = (0, import_element78.useMemo)(
...
function PatternList() {
  ...
  const [showPatternModal, setShowPatternModal] = (0, import_element79.useState)(false);
  const handleQueryParamsChange = (0, import_element79.useCallback)(
    (params) => {
      navigate({
        search: {
          ...searchParams,
  ...
  const categoryFilter = (0, import_element79.useMemo)(() => {
    const filter = view.filters?.find((f2) => f2.field === "category");
    return filter?.value || "all-patterns";
  }, [view.filters]);
  const syncStatusFilter = (0, import_element79.useMemo)(() => {
    const filter = view.filters?.find((f2) => f2.field === "sync-status");
    return filter?.value;
  }, [view.filters]);
  const patternType = (0, import_element79.useMemo)(() => {
    if (type === "my-patterns") {
  ...
  const { data: posts, paginationInfo } = (0, import_element79.useMemo)(() => {
  ...
  const cleanupDeletedPostIdsFromUrl = (0, import_element79.useCallback)(
    (deletedItems) => {
  ...
  const handleTabChange = (0, import_element79.useCallback)(
    (typeSlug) => {
      navigate({
