...
if (typeof process === "undefined" || true) {
  registerStyle4("eb30553938", "._0a72644d00175b3d__root{background-color:var(--wpds-color-bg-surface-brand,color-mix(in oklch,var(--wp-admin-theme-color,#3858e9) 9%,#fff));color:var(--wpds-color-fg-interactive-brand,var(--wp-admin-theme-color,#3858e9));height:100%;padding:var(--wpds-dimension-padding-2xl,24px)}._27db09cc57742421__quote{font-family:Georgia,Times New Roman,Times,serif;font-style:italic;text-align:center}");
}
