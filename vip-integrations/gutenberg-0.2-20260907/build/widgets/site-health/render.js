...
if (typeof process === "undefined" || true) {
  registerStyle4("81af0bb6e8", "._102f70874f5f6f85__root{flex-shrink:0;height:64px;width:64px}._102f70874f5f6f85__root.c2b8e83bf37a1369__success{--site-health-stroke:var(--wpds-color-stroke-surface-success,#92d19d);--site-health-fg:var(--wpds-color-foreground-content-success,#002900)}._102f70874f5f6f85__root._54958716847ff487__warning{--site-health-stroke:var(--wpds-color-stroke-surface-warning,#e1be80);--site-health-fg:var(--wpds-color-foreground-content-warning,#2e1900)}._102f70874f5f6f85__root._3173cf56308a969a__error{--site-health-stroke:var(--wpds-color-stroke-surface-error,#dfafa8);--site-health-fg:var(--wpds-color-foreground-content-error,#470000)}._102f70874f5f6f85__root circle:first-child{stroke:var(--wpds-color-background-track-neutral,#dbdbdb);stroke-width:12}._102f70874f5f6f85__root circle:last-of-type{stroke:var(--site-health-stroke);stroke-width:12;stroke-linecap:round;transform:rotate(-90deg);transform-origin:50% 50%;transition:stroke-dashoffset .5s ease}.fcddc693d8da23b7__percentage{fill:var(--site-health-fg);font-size:36px;font-weight:var(--wpds-typography-font-weight-emphasis,600)}");
}
...
function reviewHref(counts) {
  const statuses = ["critical", "recommended"].filter(
