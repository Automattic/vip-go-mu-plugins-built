...
`)}var Hl=/^#[xX]([A-Fa-f0-9]+)$/,Gl=/^#([0-9]+)$/,Kl=/^([A-Za-z0-9]+)$/,_f=(function(){function e(t){this.named=t}return e.prototype.parse=function(t){if(t){var r=t.match(Hl);if(r)return String.fromCharCode(parseInt(r[1],16));if(r=t.match(Gl),r)return String.fromCharCode(parseInt(r[1],10));if(r=t.match(Kl),r)return this.named[r[1]]}},e})(),Wl=/[\t\n\f ]/,Yl=/[A-Za-z]/,Zl=/\r\n?/g;function le(e){return Wl.test(e)}function Li(e){return Yl.test(e)}function Xl(e){return e.replace(Zl,`
