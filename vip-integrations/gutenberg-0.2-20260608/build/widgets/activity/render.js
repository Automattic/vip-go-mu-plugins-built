...
function usePopupViewport(parameters) {
  ...
  if (!isTransitioning) {
    ...
    childrenToRender = /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)(React33.Fragment, {
...
var FloatingPortalLite = /* @__PURE__ */ React34.forwardRef(function FloatingPortalLite2(componentProps, forwardedRef) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)(React34.Fragment, {
...
var TooltipRoot = fastComponent(function TooltipRoot2(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(TooltipRootContext.Provider, {
    value: store,
...
var Visual = (0, import_element18.forwardRef)(
...
var Icon3 = (0, import_element19.forwardRef)(
...
var Description = (0, import_element21.forwardRef)(function EmptyStateDescription({ render: render4 = DEFAULT_TAG2, className, children, ...props }, ref) {
...
var Actions = (0, import_element22.forwardRef)(
...
// packages/dataviews/build-module/components/dataviews-context/index.mjs
var DataViewsContext = (0, import_element25.createContext)({
  ...
  containerWidth: 0,
  containerRef: (0, import_element25.createRef)(),
  resizeObserverRef: () => {
  },
...
function ActionsMenuGroup({
  ...
  const { primaryActions, regularActions } = (0, import_element26.useMemo)(() => {
...
function PrimaryActions({
  ...
  const [activeModalAction, setActiveModalAction] = (0, import_element26.useState)(null);
  const isMobileViewport = (0, import_compose.useViewportMatch)("medium", "<");
  if (isMobileViewport) {
    return null;
  }
...
function ActionWithModal({
  ...
  const [isModalOpen, setIsModalOpen] = (0, import_element27.useState)(false);
...
function BulkSelectionCheckbox({
  ...
  const selectableItems = (0, import_element27.useMemo)(() => {
...
function ActionButton({
  ...
  const selectedEligibleItems = (0, import_element27.useMemo)(() => {
...
function FooterContent({
  ...
  const [actionInProgress, setActionInProgress] = (0, import_element27.useState)(
    null
  );
  const footerContentRef = (0, import_element27.useRef)(void 0);
  const isMobile = (0, import_compose2.useViewportMatch)("medium", "<");
  const bulkActions = (0, import_element27.useMemo)(
  ...
  const selectedItems = (0, import_element27.useMemo)(() => {
    return data.filter(
      (item) => selection.includes(getItemId(item)) && selectableItems.includes(item)
    );
  }, [selection, data, getItemId, selectableItems]);
  const actionsToShow = (0, import_element27.useMemo)(
...
function WithMenuSeparators({ children }) {
  return import_element28.Children.toArray(children).filter(Boolean).map((child, i2) => /* @__PURE__ */ (0, import_jsx_runtime50.jsxs)(import_element28.Fragment, { children: [
    i2 > 0 && /* @__PURE__ */ (0, import_jsx_runtime50.jsx)(Menu2.Separator, {}),
    child
  ] }, i2));
}
var _HeaderMenu = (0, import_element28.forwardRef)(function HeaderMenu({
  fieldId,
  view,
  fields,
  onChangeView,
  ...
  const { setIsShowingFilter } = (0, import_element28.useContext)(dataviews_context_default);
  if (!field) {
    return null;
  }
...
function ItemClickWrapper({
  ...
  if (renderItemLink) {
    ...
    return (0, import_element29.cloneElement)(renderedElement, {
      onClick: (event) => {
        event.stopPropagation();
...
function useScrollState({
  ...
  const [isHorizontalScrollEnd, setIsHorizontalScrollEnd] = (0, import_element30.useState)(false);
  const [isVerticallyScrolled, setIsVerticallyScrolled] = (0, import_element30.useState)(false);
  const handleScroll = (0, import_element30.useCallback)(() => {
...
function useDelayedLoading(isLoading, options = { delay: 400 }) {
  const [showLoader, setShowLoader] = (0, import_element32.useState)(false);
...
function ViewTable({
  ...
  const { containerRef } = (0, import_element33.useContext)(dataviews_context_default);
  const isDelayedLoading = useDelayedLoading(isLoading);
  const headerMenuRefs = (0, import_element33.useRef)(/* @__PURE__ */ new Map());
  const headerMenuToFocusRef = (0, import_element33.useRef)(void 0);
  const [nextHeaderMenuToFocus, setNextHeaderMenuToFocus] = (0, import_element33.useState)();
  const [contextMenuAnchor, setContextMenuAnchor] = (0, import_element33.useState)(null);
  ...
  const tableNoticeId = (0, import_element33.useId)();
...
var GridItems = (0, import_element35.forwardRef)(({ className, previewSize, ...props }, ref) => {
...
function useIntersectionObserver(elementRef, posinset) {
  const { intersectionObserver } = (0, import_element36.useContext)(dataviews_context_default);
...
var GridItem = (0, import_element37.forwardRef)(
  function GridItem2({
    view,
    selection,
    onChangeSelection,
    ...
    const setRefs = (0, import_element37.useCallback)(
      (node) => {
...
function CompositeGrid({
  ...
  const { paginationInfo, resizeObserverRef } = (0, import_element37.useContext)(dataviews_context_default);
...
function PrimaryActionGridCell({
  ...
  const [isModalOpen, setIsModalOpen] = (0, import_element38.useState)(false);
...
function ListItem({
  ...
  const itemRef = (0, import_element38.useRef)(null);
  const labelId = `${idPrefix}-label`;
  const descriptionId = `${idPrefix}-description`;
  const registry = (0, import_data3.useRegistry)();
  const [isHovered, setIsHovered] = (0, import_element38.useState)(false);
  const [activeModalAction, setActiveModalAction] = (0, import_element38.useState)(
    null
  );
  ...
  const { primaryAction, eligibleActions } = (0, import_element38.useMemo)(() => {
    const _eligibleActions = actions.filter(
      (action) => !action.isEligible || action.isEligible(item)
    );
    const _primaryActions = _eligibleActions.filter(
...
function ViewList(props) {
  ...
  const generateCompositeItemIdPrefix = (0, import_element38.useCallback)(
    (item) => `${baseId}-${getItemId(item)}`,
    [baseId, getItemId]
  );
  const isActiveCompositeItem = (0, import_element38.useCallback)(
    (item, idToCheck) => {
  ...
  const [activeCompositeId, setActiveCompositeId] = (0, import_element38.useState)(void 0);
  const compositeRef = (0, import_element38.useRef)(null);
  (0, import_element38.useEffect)(() => {
    if (selectedItem) {
  ...
  const selectCompositeItem = (0, import_element38.useCallback)(
  ...
  const onDropdownTriggerKeyDown = (0, import_element38.useCallback)(
    (event) => {
...
function ActivityGroup({
  ...
  const groupHeader = showLabel ? (0, import_element39.createInterpolateElement)(
...
function ActivityItem(props) {
  ...
  const { primaryActions, eligibleActions } = (0, import_element40.useMemo)(() => {
    const _eligibleActions = actions.filter(
      (action) => !action.isEligible || action.isEligible(item)
    );
    const _primaryActions = _eligibleActions.filter(
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime63.jsx)(
          Stack,
          {
            ...
            children: (0, import_element41.createInterpolateElement)(
...
var dataviews_pagination_default = (0, import_element41.memo)(DataViewsPagination);
...
function ViewPickerGrid({
  ...
  const { resizeObserverRef, paginationInfo, itemListLabel } = (0, import_element43.useContext)(dataviews_context_default);
  const titleField = fields.find(
    (field) => field.id === view?.titleField
  );
  const mediaField = fields.find(
...
function ViewPickerTable({
  ...
  const headerMenuRefs = (0, import_element44.useRef)(/* @__PURE__ */ new Map());
  const headerMenuToFocusRef = (0, import_element44.useRef)(void 0);
  const [nextHeaderMenuToFocus, setNextHeaderMenuToFocus] = (0, import_element44.useState)();
  ...
  const dataByGroup = groupField ? getDataByGroup(data, groupField) : null;
  const isInfiniteScroll = view.infiniteScrollEnabled && !dataByGroup;
  const tableNoticeId = (0, import_element44.useId)();
  if (nextHeaderMenuToFocus) {
    headerMenuToFocusRef.current = nextHeaderMenuToFocus;
    setNextHeaderMenuToFocus(void 0);
    return;
...
function PreviewSizePicker() {
  const context = (0, import_element46.useContext)(dataviews_context_default);
  const view = context.view;
...
var CompositeItem = memo22(
  forwardRef210(function CompositeItem2(props) {
...
var Composite5 = forwardRef210(function Composite22(props) {
...
var DisclosureContent = forwardRef210(function DisclosureContent2({
  unmountOnHide,
  ...props
}) {
  const context = useDisclosureProviderContext();
...
var PopoverAnchor = forwardRef210(function PopoverAnchor2(props) {
...
var CompositeHover = memo22(
  forwardRef210(function CompositeHover2(props) {
...
var ComboboxItem = memo22(
  forwardRef210(function ComboboxItem2(props) {
...
var ComboboxLabel = memo22(
  forwardRef210(function ComboboxLabel2(props) {
...
var ComboboxList = forwardRef210(function ComboboxList2(props) {
...
function useElements({
  ...
  const [records, setRecords] = (0, import_element47.useState)(staticElements);
...
function ListBox({ view, filter, onChangeView }) {
  ...
  const [activeCompositeId, setActiveCompositeId] = (0, import_element48.useState)(
...
function ComboboxList22({ view, filter, onChangeView }) {
  const [searchValue, setSearchValue] = (0, import_element48.useState)("");
  const deferredSearchValue = (0, import_element48.useDeferredValue)(searchValue);
  const currentFilter = view.filters?.find(
    (_filter) => _filter.field === filter.field
  );
  const currentValue = getCurrentValue(filter, currentFilter);
  const matches = (0, import_element48.useMemo)(() => {
    ...
    ComboboxProvider,
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime78.jsxs)("div", { className: "dataviews-filters__search-widget-filter-combobox__wrapper", children: [
          /* @__PURE__ */ (0, import_jsx_runtime78.jsx)(VisuallyHidden, { render: /* @__PURE__ */ (0, import_jsx_runtime78.jsx)(ComboboxLabel, {}), children: (0, import_i18n23.__)("Search items") }),
          /* @__PURE__ */ (0, import_jsx_runtime78.jsx)(
            Combobox,
            {
              autoSelect: "always",
...
function InputWidget({
  ...
  const currentValue = getCurrentValue(filter, currentFilter);
  const field = (0, import_element49.useMemo)(() => {
  ...
  const data = (0, import_element49.useMemo)(() => {
...
var isNoneOperatorDefinition = {
  ...
  filterText: (filter, activeElements) => (0, import_element50.createInterpolateElement)(
...
function Filter({
  ...
  const toggleRef = (0, import_element51.useRef)(null);
    ...
    import_components20.Dropdown,
    {
      ...
      renderToggle: ({ isOpen, onToggle }) => /* @__PURE__ */ (0, import_jsx_runtime81.jsxs)("div", { className: "dataviews-filters__summary-chip-container", children: [
        /* @__PURE__ */ (0, import_jsx_runtime81.jsxs)(tooltip_exports.Root, { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime81.jsx)(tooltip_exports.Popup, { children: (0, import_i18n25.sprintf)(
...
var add_filter_default = (0, import_element52.forwardRef)(AddFilter);
...
function Filters({ className }) {
  const { fields, view, onChangeView, openedFilter, setOpenedFilter } = (0, import_element54.useContext)(dataviews_context_default);
  const addFilterRef = (0, import_element54.useRef)(null);
...
var filters_default = (0, import_element54.memo)(Filters);
...
function FiltersToggle() {
  ...
  const buttonRef = (0, import_element55.useRef)(null);
  const onChangeViewWithFilterVisibility = (0, import_element55.useCallback)(
    (_view) => {
      onChangeView(_view);
      setIsShowingFilter(true);
    },
...
function FiltersToggled(props) {
  const { isShowingFilter } = (0, import_element56.useContext)(dataviews_context_default);
  if (!isShowingFilter) {
    return null;
  }
...
var DataViewsSearch = (0, import_element59.memo)(function Search({ label }) {
  const { view, onChangeView } = (0, import_element59.useContext)(dataviews_context_default);
...
function ViewTypeMenu() {
  const { view, onChangeView, defaultLayouts } = (0, import_element60.useContext)(dataviews_context_default);
...
function SortFieldControl() {
  const { view, fields, onChangeView } = (0, import_element60.useContext)(dataviews_context_default);
  const orderOptions = (0, import_element60.useMemo)(() => {
...
function ItemsPerPageControl() {
  const { view, config, onChangeView } = (0, import_element60.useContext)(dataviews_context_default);
...
function ResetViewButton() {
  const { onReset } = (0, import_element60.useContext)(dataviews_context_default);
  if (onReset === void 0) {
    return null;
  }
...
function DataviewsViewConfigDropdown() {
  const { view, onReset } = (0, import_element60.useContext)(dataviews_context_default);
...
var DataViewsViewConfig = (0, import_element60.memo)(_DataViewsViewConfig);
...
function Combobox3({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime92.jsx)(import_components28.Spinner, {});
  }
...
function RelativeDateControl({
  ...
  const onChangeValue = (0, import_element63.useCallback)(
    (newValue) => onChange(
      setValue({
        item: data,
  ...
  const onChangeUnit = (0, import_element63.useCallback)(
    (newUnit) => onChange(
      setValue({
        item: data,
...
function useDisabledDateMatchers(isValid2, parseDateFn) {
  ...
  const disabledMatchers = (0, import_element64.useMemo)(() => {
    const matchers = [];
    if (minConstraint) {
...
function CalendarDateTimeControl({
  ...
  const inputControlRef = (0, import_element65.useRef)(null);
  const validationTimeoutRef = (0, import_element65.useRef)(void 0);
  const previousFocusRef = (0, import_element65.useRef)(null);
  ...
  const handleManualDateTimeChange = (0, import_element65.useCallback)(
    (newValue) => {
      if (newValue) {
...
function ValidatedDateControl({
  ...
  const [customValidity, setCustomValidity] = (0, import_element66.useState)(void 0);
  const validateRefs = (0, import_element66.useCallback)(() => {
...
function CalendarDateControl({
  ...
  const disabled2 = field.isDisabled({ item: data, field });
  const [selectedPresetId, setSelectedPresetId] = (0, import_element66.useState)(
    null
  );
  const weekStartsOn = fieldFormat.weekStartsOn ?? (0, import_date4.getSettings)().l10n.startOfWeek;
  const fieldValue = getValue({ item: data });
  const value = typeof fieldValue === "string" ? fieldValue : void 0;
  const [calendarMonth, setCalendarMonth] = (0, import_element66.useState)(() => {
    const parsedDate = parseDate(value);
    return parsedDate || /* @__PURE__ */ new Date();
  });
  const [isTouched, setIsTouched] = (0, import_element66.useState)(false);
  ...
  const onChangeCallback = (0, import_element66.useCallback)(
    (newValue) => onChange(setValue({ item: data, value: newValue })),
    [data, onChange, setValue]
  );
  const onSelectDate = (0, import_element66.useCallback)(
    (newDate) => {
  ...
  const handlePresetClick = (0, import_element66.useCallback)(
    (preset) => {
  ...
  const handleManualDateChange = (0, import_element66.useCallback)(
    (newValue) => {
...
function CalendarDateRangeControl({
  ...
  const selectedRange = (0, import_element66.useMemo)(() => {
    if (!value) {
  ...
  const [isTouched, setIsTouched] = (0, import_element66.useState)(false);
  const fromInputRef = (0, import_element66.useRef)(null);
  const toInputRef = (0, import_element66.useRef)(null);
  const updateDateRange = (0, import_element66.useCallback)(
    (fromDate, toDate2) => {
      if (fromDate && toDate2) {
        onChangeCallback([
          formatDate(fromDate),
  ...
  const onSelectCalendarRange = (0, import_element66.useCallback)(
    (newRange) => {
...
function Select({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime96.jsx)(import_components32.Spinner, {});
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime99.jsx)(
    ValidatedText,
    {
      ...{
        ...
        validity,
        type: "email",
        prefix: /* @__PURE__ */ (0, import_jsx_runtime99.jsx)(import_components34.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime99.jsx)(import_components34.Icon, { icon: envelope_default }) })
      }
    }
  );
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime100.jsx)(
    ValidatedText,
    {
      ...{
        ...
        validity,
        type: "tel",
        prefix: /* @__PURE__ */ (0, import_jsx_runtime100.jsx)(import_components35.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime100.jsx)(import_components35.Icon, { icon: mobile_default }) })
      }
    }
  );
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime101.jsx)(
    ValidatedText,
    {
      ...{
        ...
        validity,
        type: "url",
        prefix: /* @__PURE__ */ (0, import_jsx_runtime101.jsx)(import_components36.__experimentalInputControlPrefixWrapper, { variant: "icon", children: /* @__PURE__ */ (0, import_jsx_runtime101.jsx)(import_components36.Icon, { icon: link_default }) })
      }
    }
  );
}
...
function BetweenControls({
  ...
  const onChangeMin = (0, import_element69.useCallback)(
    (newValue) => onChange([toNumberOrEmpty(newValue), max2]),
    [onChange, max2]
  );
  const onChangeMax = (0, import_element69.useCallback)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime102.jsx)(
    import_components37.BaseControl,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime102.jsxs)(import_components37.Flex, { direction: "row", gap: 4, children: [
...
function ValidatedNumber({
  ...
  const onChangeBetweenControls = (0, import_element69.useCallback)(
    (newValue) => {
      onChange(
        setValue({
          item: data,
...
function Radio({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime105.jsx)(import_components38.Spinner, {});
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime106.jsx)(
    ValidatedText,
    {
      ...{
        ...
        markWhenOptional,
        validity,
        prefix: prefix ? (0, import_element71.createElement)(prefix) : void 0,
        suffix: suffix ? (0, import_element71.createElement)(suffix) : void 0
      }
    }
  );
}
...
function ToggleGroup({
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime109.jsx)(import_components41.Spinner, {});
  }
  if (elements.length === 0) {
    return null;
  }
...
function ArrayControl({
  ...
  const arrayValueAsElements = (0, import_element75.useMemo)(
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime110.jsx)(import_components42.Spinner, {});
  }
    ...
    import_components43.Dropdown,
    {
      ...
      renderToggle: ({ onToggle }) => /* @__PURE__ */ (0, import_jsx_runtime111.jsx)(
        import_components43.Button,
        {
          ...
          disabled: disabled2,
          accessibleWhenDisabled: true,
          icon: () => /* @__PURE__ */ (0, import_jsx_runtime111.jsx)(import_components43.ColorIndicator, { colorValue: validColor })
        }
      ),
      renderContent: () => /* @__PURE__ */ (0, import_jsx_runtime111.jsx)(import_components43.__experimentalDropdownContentWrapper, { paddingSize: "none", children: /* @__PURE__ */ (0, import_jsx_runtime111.jsx)(
...
function Color({
  ...
  const disabled2 = field.isDisabled({ item: data, field });
  const value = field.getValue({ item: data }) || "";
  const handleColorChange = (0, import_element76.useCallback)(
    (newColor) => {
      onChange(setValue({ item: data, value: newColor }));
    },
    [data, onChange, setValue]
  );
  const handleInputChange = (0, import_element76.useCallback)(
    (newValue) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime111.jsx)(
    ValidatedInputControl3,
    {
      ...
      type: "text",
      disabled: disabled2,
      prefix: /* @__PURE__ */ (0, import_jsx_runtime111.jsx)(import_components43.__experimentalInputControlPrefixWrapper, { variant: "control", children: /* @__PURE__ */ (0, import_jsx_runtime111.jsx)(
        ColorPickerDropdown,
        {
          color: value,
...
function Password({
  ...
  const [isVisible2, setIsVisible] = (0, import_element77.useState)(false);
  const disabled2 = field.isDisabled({ item: data, field });
  const toggleVisibility = (0, import_element77.useCallback)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime112.jsx)(
    ValidatedText,
    {
      ...{
        ...
        suffix: /* @__PURE__ */ (0, import_jsx_runtime112.jsx)(import_components44.__experimentalInputControlSuffixWrapper, { variant: "control", children: /* @__PURE__ */ (0, import_jsx_runtime112.jsx)(
...
function useData({
  ...
  const [hasInitiallyLoaded, setHasInitiallyLoaded] = (0, import_element78.useState)(
    !isLoading
  );
  ...
  const previousDataRef = (0, import_element78.useRef)(shownData);
  const previousPaginationInfoRef = (0, import_element78.useRef)(paginationInfo);
  (0, import_element78.useEffect)(() => {
    if (!isLoading) {
  ...
  const [visibleEntries, setVisibleEntries] = (0, import_element78.useState)([]);
  const positionMapRef = (0, import_element78.useRef)(/* @__PURE__ */ new Map());
  const allLoadedRecordsRef = (0, import_element78.useRef)([]);
  const prevViewParamsRef = (0, import_element78.useRef)({
    search: void 0,
    filters: void 0,
    perPage: void 0
  });
  const scrollDirectionRef = (0, import_element78.useRef)(void 0);
  const prevStartPositionRef = (0, import_element78.useRef)(void 0);
  const hasInitializedRef = (0, import_element78.useRef)(false);
  const allLoadedRecords = (0, import_element78.useMemo)(() => {
...
function useInfiniteScroll({
  ...
  const anchorElementRef = (0, import_element79.useRef)(null);
  const viewRef = (0, import_element79.useRef)(view);
  const isLoadingRef = (0, import_element79.useRef)(isLoading);
  const onChangeViewRef = (0, import_element79.useRef)(onChangeView);
  const totalItemsRef = (0, import_element79.useRef)(paginationInfo.totalItems);
  ...
  const intersectionObserverCallback = (0, import_element79.useCallback)(
    (entries) => {
  ...
  const intersectionObserverRef = (0, import_element79.useRef)(
    null
  );
...
function DefaultUI({
  ...
  const { view } = (0, import_element80.useContext)(dataviews_context_default);
...
function DataViews({
  ...
  const [selectionState, setSelectionState] = (0, import_element80.useState)([]);
  ...
  const containerRef = (0, import_element80.useRef)(null);
  const [containerWidth, setContainerWidth] = (0, import_element80.useState)(0);
  ...
  const [openedFilter, setOpenedFilter] = (0, import_element80.useState)(null);
  ...
  const _fields = (0, import_element80.useMemo)(() => normalizeFields(fields), [fields]);
  const _selection = (0, import_element80.useMemo)(() => {
  ...
  const hasPrimaryOrLockedFilters = (0, import_element80.useMemo)(
    () => (filters || []).some(
      (filter) => filter.isPrimary || filter.isLocked
    ),
    [filters]
  );
  const [isShowingFilter, setIsShowingFilter] = (0, import_element80.useState)(
  ...
  const defaultLayouts = (0, import_element80.useMemo)(
    () => Object.fromEntries(
...
function formatGroupDate(dateStr) {
  ...
  if (dateStr === today) {
    return (0, import_i18n44.__)("Today");
  }
  const yesterday = (0, import_date10.getDate)();
  yesterday.setDate(yesterday.getDate() - 1);
  const yesterdayStr = (0, import_date10.dateI18n)("Y-m-d", yesterday);
  if (dateStr === yesterdayStr) {
    return (0, import_i18n44.__)("Yesterday");
  }
  const currentYear = (0, import_date10.dateI18n)("Y", now);
  if (dateStr.slice(0, 4) === currentYear) {
    return (0, import_date10.dateI18n)((0, import_i18n44.__)("M jS"), dateStr);
  }
  return (0, import_date10.dateI18n)((0, import_i18n44.__)("M jS Y"), dateStr);
}
...
var FIELDS = [
  {
    id: "icon",
    label: (0, import_i18n44.__)("Icon"),
    type: "media",
    render: ({ item }) => /* @__PURE__ */ (0, import_jsx_runtime117.jsx)(icon_default, { icon: item.kind === "comment" ? comment_default : post_list_default }),
    enableSorting: false,
    enableHiding: false
  },
  {
  ...
  {
    id: "datetime",
    label: (0, import_i18n44.__)("Time"),
    getValue: ({ item }) => item.datetime,
    render: ({ item }) => /* @__PURE__ */ (0, import_jsx_runtime117.jsx)("span", { children: (0, import_date10.dateI18n)((0, import_i18n44.__)("g:i a"), item.datetime) }),
    enableSorting: true
  },
  {
    id: "date",
    ...
    render: ({ item }) => /* @__PURE__ */ (0, import_jsx_runtime117.jsx)("span", { children: formatGroupDate(item.datetime.split("T")[0]) }),
    enableSorting: true,
    enableHiding: false
  }
];
...
function Activity({
  ...
  const [view, setView] = (0, import_element81.useState)(DEFAULT_VIEW);
  const queries = (0, import_element81.useMemo)(
    () => ({
      future: {
        status: "future",
        orderby: "date",
  ...
  const allEvents = (0, import_element81.useMemo)(() => {
    const events = [];
  ...
  const resolvedView = (0, import_element81.useMemo)(
    () => ({ ...view, perPage: perPage * SOURCE_COUNT }),
    [view, perPage]
  );
  const { data: shownData, paginationInfo } = (0, import_element81.useMemo)(
  ...
  if (!isResolved) {
    return /* @__PURE__ */ (0, import_jsx_runtime117.jsx)(
      Stack,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime117.jsx)(import_components45.Spinner, {})
      }
    );
  }
  if (allEvents.length === 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime117.jsx)(
      Stack,
      {
        ...
        justify: "center",
        className: style_default13.loading,
        children: /* @__PURE__ */ (0, import_jsx_runtime117.jsxs)(empty_state_exports.Root, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime117.jsx)(empty_state_exports.Icon, { icon: post_list_default }),
          /* @__PURE__ */ (0, import_jsx_runtime117.jsx)(empty_state_exports.Title, { children: (0, import_i18n44.__)("No activity yet.") }),
          /* @__PURE__ */ (0, import_jsx_runtime117.jsx)(empty_state_exports.Description, { children: (0, import_i18n44.__)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime117.jsx)(Stack, { direction: "column", className: style_default13.list, children: /* @__PURE__ */ (0, import_jsx_runtime117.jsx)(
    dataviews_default,
    {
      data: shownData,
      fields: FIELDS,
      ...
      renderItemLink: ({ item, children, ...aProps }) => /* @__PURE__ */ (0, import_jsx_runtime117.jsx)(Link, { href: item.link, ...aProps, children }),
      isItemClickable: (item) => !!item.link,
      children: /* @__PURE__ */ (0, import_jsx_runtime117.jsx)(dataviews_default.Layout, {})
    }
  ) });
}
export {
